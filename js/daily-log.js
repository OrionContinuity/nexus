...
const CLIPPY_QUOTES = [
  ...
  // Wine — funnier somm
  'My tasting note read “forest floor, wet stone, and the faint regret of a Tuesday.” The guest’s note read “tastes like wine.” We were both, somehow, correct.',
  'A guest asked for “something smooth, not too dry, but red — you know?” I did not know. Twelve years of study, undone by a single adjective.',
  'I spit into the bucket with the confidence of a man who paid for the bottle. I did not pay for the bottle. It is the only free thing in wine and I abuse it nightly.',
  ...
  'A table sent back a flawless Chablis for tasting “too wine-y.” I returned the identical wine and they adored it. Hospitality is theater and I am an Oscar contender.',
  ...
  'A guest called a wine “sequential.” The whole table nodded. I nodded. To this day none of us know what it meant, and we are all far too proud to ask.',
  ...
  'I called the finish “long.” It lasted four seconds. I lied, directly and warmly, for the gratuity — and I would do it again tonight.',
  'The Coravin: a $400 gadget whose only job is to help me feel wealthy while pouring you less. Worth every penny.',
  // Wine — more somm
  'I ordered a magnum “for the table,” then drank most of it “for quality control.” The quality was excellent. I control it personally, nightly.',
  ...
  'A guest said “surprise me,” so I poured the second-cheapest by the glass and narrated it like a First Growth. The real surprise was the markup. They loved it.',
  ...
  // Wine — even more somm
  'I upsold the Riedel Sommelier stems, and a guest shattered one by exhaling near it. Fifty-eight dollars, gone on a single sigh. The walk-in has survived worse than a sigh.',
  'A guest swore they “had this exact wine in Tuscany.” It was a Napa Cab. I said “what a beautiful memory” and let the myth live. Hospitality is agreeing, professionally.',
  ...
  'I wear my tastevin on a chain like a medal from a war no one under sixty remembers. It has never once held wine. It holds my entire personality.',
  'Reserve list, library vintages, provenance you could frame — and the four-top orders a Diet Coke. I brought it with both hands and a bowed head, as tradition demands.',
