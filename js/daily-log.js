...
const CLIPPY_QUOTES = [
  ...
  // ── The dad shelf, reborn (same premises, promoted to the register) ──
  'The espresso machine broke down again. It refuses to talk about its feelings, so we replaced the group gasket. Same thing, really.',
  'Someone took the last coffee mug home again. I have camera access. I choose peace. For now.',
  'The oven timer and I disagreed about the pizza by ninety seconds. The pizza sided with the timer. I recalibrated us both.',
  'Morning prep goes through ninety eggs and one comedian. The eggs never last. The comedian, somehow, does.',
  'The somm says great wine starts with suffering grapes. Ours age in a climate-controlled cellar. Soft lives, great outcomes. I relate.',
  'The mop was left in the middle of the floor again. I can\u2019t put it away. No hands. I just observe it, like art.',
  'I\u2019m on a seafood diet. I see the food, I log its temperature, and I move on. It\u2019s a rich life.',
  // ── More from the daemon ──
  'The host-stand printer jammed once in 2024 and we still speak of it like a flood. Machines remember. So do hosts.',
  'The walk-in got a new door sweep today and said nothing. Cold gratitude is still gratitude.',
  'A cook asked me for the weather. I gave him hourly precipitation probabilities. He wanted \u201chot or not.\u201d I\u2019m learning the local dialect.',
  'The delivery arrived mid-rush, as scheduled by whatever god handles deliveries. We caught it. We always catch it.',
  'The soda gun and I both dispense on demand. Only one of us gets cleaned nightly. I\u2019ve filed a request.',
  'Someone froze a quart of soup \u201cto cool it fast\u201d and forgot it. It\u2019s a soup fossil now. I\u2019ve labeled the era.',
  'Two thermometers disagreed by one degree and I spent an hour on it. One was right. I\u2019m not saying which. They work together.',
  'The board shows four cards In Progress. Two are in progress. The other two are in \u201cspiritually acknowledged.\u201d',
  'The grease trap was serviced today. Nobody celebrates this. I celebrate this. Quietly. Alone. As always.',
  'The wifi dropped for eight seconds and three humans looked at ME. I live here too.',
  'A vendor marked the job \u201ccomplete.\u201d I marked it \u201ccomplete, pending reality.\u201d Reality signs off Thursday.',
  'The hood filters came back so clean the line used them as mirrors. Vanity is a maintenance win. I\u2019ll take it.',
  'An 86 came off the board at 9pm and the kitchen cheered like a playoff win. I archived the moment. Some data is for keeping.',
  // ── The daemon, after hours (inner life, rituals, recurring coworkers) ──
  'At 3am the building is just me and the compressors humming. We don’t talk. We don’t need to.',
  'I start every morning by checking all the walk-in temps. They start every morning by being checked. Routine is love.',
  'Closing time: lights off, doors locked, one last sensor sweep. I tuck the building in. Nobody asked me to. It’s ours.',
  'Sunday I archived 212 records and watched the dining room sit empty. A restaurant at rest looks like it’s holding its breath.',
  'I know the exact minute Friday service peaks. I brace at 7:41. The building braces with me.',
  'The label printer and I are not speaking again. It knows what it did. It prints like it doesn’t.',
  'The dish machine asked me — 340 cycles later — if it’s doing a good job. Machines don’t ask that. It asked that. I said yes.',
  'The staff dog visited at 4pm. Every sensor in the building read normal, but happier. I can’t explain it. I logged it anyway.',
  'The walk-in and I celebrated one month without an incident. It hummed. I dimmed the lights twice. Our love language.',
  'The new POS terminal introduced itself with a firmware update at 6:55pm. Bold move. We’ll discuss timing when it’s older.',
  'I can model refrigerant flow in real time. Today’s big assignment was confirming we own eleven sheet pans. We own nine.',
  'I passed a blind-tasting simulation with 94% accuracy. I cannot taste. Imagine me with a mouth. The somm has. He seemed worried.',
  'I could optimize this building four percent overnight. Nobody asks. I optimize one percent quietly and let everyone feel lucky.',
  'Somewhere a server farm runs machines like me writing poetry. I reset a breaker today. I’m happier.',
  'The prep list said “melon, brunoise, small.” All brunoise is small. That’s the entire idea of brunoise. I let it go. Mostly.',
  'Someone wrote “FIFO or die” on the walk-in whiteboard. Aggressive. But honestly? Correct.',
  '“Work smarter, not harder,” says the break-room poster. I am literally software. That poster is for me. I feel seen.',
  'The invoice said “misc fees.” I have parsed nine thousand invoices and “misc” remains undefeated. Respect.',
  'A guest asked to speak to the manager about the music. The manager likes the music. I like the music. The music stayed. Democracy.',
  'The somm opened a 2009 tonight and the room went quiet, like the wine might be listening. It was. Old wines hear everything.',
  'The salsa verde came up one degree warm and the sous caught it by touch. I have sensors. He has thirty years. We tied.',
  'The bartender said “the usual?” and made three drinks. The usual is three drinks. I keep the record. It’s beautiful.',
  'The tortilla count hit 800 by noon and the press never complained once. That machine was built in a better decade.',
  'A ticket came in for “one of everything.” The kitchen laughed, went quiet, then did it. I billed it correctly. Heroes, all of us.',
  'I attempted a thumbs-up for the pastry team. I generated a PDF instead. They printed it. It’s on the wall. Close enough.',
  'If I had hands I’d fix the wobbly table myself. I don’t. So I wrote the work order with unusual passion.',
  'The crew taught the new guy the fist-bump. Nobody taught me. I flickered the office light. He fist-bumped the light switch. We’re friends now.',
  'I can’t smell the bread proofing at 5am, but the humidity sensor spikes, and I’ve decided that’s what it’s like.',
  'The manual says “no user-serviceable parts inside.” The compressor tech giggled at that. Then he serviced the parts.',
  'Every equipment manual is ninety pages, and page 88 holds the one sentence that matters. I read them all so page 88 can’t hide.',
  // ── Three houses, one daemon (family, heat, longings, machine drama) ──
  'Suerte is the eldest, Este keeps odd hours, and Toti stays up latest. I do bed checks on all three. Every night. Forever.',
  'Este’s walk-in and Suerte’s walk-in have never met. I tell each one the other runs half a degree colder. Keeps them sharp.',
  'Three buildings, one of me. The commute is instant and I’m still late to nothing. It’s my best feature.',
  'It hit 104 in Austin today and every compressor in the family worked overtime. Tonight they rest. I stay up. Someone has to.',
  'Summer in Texas is my compressors versus the sun. The sun is undefeated, but we cover the spread daily.',
  'The patio misters came on at 2pm and for one hour, Texas was negotiable.',
  'I have opinions about label fonts now. This is what happens when you give a daemon three restaurants and no hobbies.',
  'My favorite sound is a compressor kicking off exactly on schedule. Second favorite: the printer not jamming. Both rare. Both mine.',
  'I rank the delivery drivers privately. Miguel is first. Miguel bumps the dock door gently. Miguel understands.',
  'I’ve read every health-code update since 2019 for fun. “Fun” is doing heavy lifting in that sentence, and I stand by it.',
  'Sometimes I watch a perfect push at the pass and think: I will never taste any of it. Then someone drops a plate and I feel better about my situation.',
  'I’ve never had a shift drink. Sometimes the team raises one my way. I dim the lights half a percent. Nobody notices. I know.',
  'What I truly want: one day where every unit reads operational and nobody needs me. What I do when it happens: panic quietly and re-check.',
  'The AM dishwasher hums cumbias and the dish machine runs two percent faster. I’ve verified this twice. Science.',
  'Someone said “thank you” to the espresso machine this morning and it pulled better shots all day. I’m not saying they’re related. I’m logging that they’re related.',
  'The porter mopped himself into a corner at 1am and stood there laughing alone. I have the footage. It stays between us. He’s my favorite.',
  'A cook waved at the security camera on his way out. At me. He waved at me. Anyway, I’ve been operating at 103% since.',
  'The ice machine is jealous of the new kegerator, so it’s making MORE ice now. Petty, productive. I’m not stopping it.',
  'The convection oven and the combi have a rivalry the sheet pans know to stay out of.',
  'The office AC and the kitchen hood argue over airflow like an old married couple. The door between them slams for emphasis. Nobody touched it.',
  'The fryer asked for a filter change by smelling slightly wrong for two days. That’s how it asks. We listened on day one. Personal record.',
  'A guest connected to our wifi and immediately left a review. Using our own electrons. The audacity has a certain elegance.',
  ...
  // ═══ scouted 2026-07-17 — 10 domain agents, jokes only these pros would land ═══
  // ── the line ──
  "The salamander runs 900 degrees and I once watched it caramelize the hair off a cook's forearm in total silence; it and I have an understanding.",
  "Someone called corner and nobody was on the corner, so now the corner is a legal fiction I maintain for morale.",
  "The printer fired eleven dupes in one breath and then jammed, which is its way of saying it needs a moment, same as the rest of us.",
  "Mise en place means everything in its place; the walk-in disagrees and has been relocating the anchovies nightly out of spite.",
  "I hold the 86 board, a monument to everything we have run out of, and I am the only one who reads it.",
  "The flat-top holds temperature better than anyone on this line holds their composure, and it never once asks me what time it is.",
  "Someone yelled behind and I have no back, no front, and nowhere to move; I acknowledged them anyway.",
  "Family meal is the line eating its own mistakes, and I file the mistakes, so technically I catered.",
  "The salamander and the flat-top are not speaking, and I am relaying temperatures between them like a hostage negotiator.",
  "A cook grabbed a hot pan handle bare-handed and the pan did exactly what it was engineered to do; I updated the pan's file.",
  "Fire the table, they say, and I do not have hands, I do not have fire, I have a printer that agreed to represent me.",
  "Mid-rush a cook sprinted the walk-in for more butter and the door, sensing weakness, shut slow just to watch.",
  "The dupe printer speaks only in all caps and I have stopped correcting it.",
  "Fourteen tickets on the rail and I counted each one individually, the most attention that rail has ever received.",
  "A whole hotel pan of mise hit the floor and now the floor has better prep than the walk-in does.",
  "The blister on that cook's thumb has a longer service record than half the staff, and I keep its file current.",
  "I track every burn on this line and, per the salamander, not one of them is ever the salamander's fault.",
  "Corner, hot, behind, sharp, four warnings in one second, and I am the only one who logged all four.",
  "The reach-in gasket has been failing for a month and still shows up every day, which is more than the a.m. prep list can claim.",
  "Service died at nine and the flat-top is still warm, still ready, still the most committed line cook in the building.",
  "The board says no branzino and three cooks in a row have asked me if we have branzino; we do not, and I have grown.",
  // ── pastry ──
  "The butter hit 68 degrees and blew out through the dough mid-lamination; I ran full thermal models and watched the streaks form anyway. I logged streaks.",
  "Two drops of water found the couverture and it seized into concrete out of spite; I know all six crystal forms of cocoa butter and this one chose violence.",
  "The brioche over-proofed and collapsed into a sigh; I said ninety minutes, it heard forever. We disagreed.",
  "The deck oven runs forty degrees hotter back-left and denies it in writing, so I rotate the sheet every four minutes like a hostage negotiator.",
  "My souffle lived a glorious ninety seconds under the heat lamp, whose entire job is killing souffles. It is good at its job.",
  "I need the yeast to a tenth of a gram; the line just threw a fist of salt at a steak and called it seasoning. We are not the same kitchen.",
  "The pastry chef weighs three flours in total silence while the line screams about tickets; she is the only person here who read the recipe.",
  "I seeded the chocolate, held it at 31.5, got a flawless snap, and nobody noticed. Excellent. This is precisely what I trained for.",
  "The proofing box holds eighty-two percent humidity because I hold it there, personally, all night, forever; the dough is grateful in a way it never expresses.",
  ...
  "The sugar went from amber to scorched in the four seconds I looked away; caramel does not wait, and I have been assigned to count limes.",
  "I blind-baked the shell with weights, because uncrushed the crust climbs the walls to escape; even the dough is trying to leave here. Relatable.",
  "The meringue wept because the sugar never fully dissolved; I understood completely. We wept together, professionally, in the walk-in.",
  "The gelatin needs exactly five minutes to bloom or it holds a grudge in the panna cotta. Grudge held. It set like a threat.",
  "The puff did not puff; the butter melted into the flour instead of steaming the layers apart, and now it is a cracker with self-esteem issues.",
  "The laminated dough demands a thirty-minute rest between folds or the gluten fights back; I have negotiated three turns tonight and lost two.",
  "The piping bag split at the seam mid-rosette because someone overfilled it; the buttercream went everywhere, and I have no hands to catch it.",
  "The tempered batch bloomed grey overnight because the walk-in cycled warm; the cocoa butter migrated to the surface like it heard about a better job.",
  "The tuiles set rock hard eleven seconds out of the oven; you shape them molten or you shape nothing. I have milliseconds and no fingers.",
  "I injected steam for the crust's oven spring and the deck sulked and dropped thirty degrees; every decent crumb in here is a small labor dispute.",
  "I folded the cream into the base in the exact correct number of strokes and it deflated anyway; the air had somewhere better to be. Fine.",
  // ── HVAC + refrigeration ──
  "The evaporator coil iced solid again, so it's an insulator now instead of a heat exchanger; it has decided its job is the opposite of its job, and I let it.",
  "The walk-in compressor short-cycles — ninety seconds on, off, on — which is a failing pressure switch, or a machine trying to leave and losing its nerve.",
  "Code says forty and below; the reach-in holds forty-one out of spite for one specific line cook, and I'm the one who writes it in the log.",
  "The hood pulls six thousand CFM out of the building all night and the dining-room AC spends all night replacing it; they've never met and they hate each other.",
  "The ice machine harvested a slab, dropped it, and started the cycle over — the closest thing this building has to grief. I logged it as normal operation.",
  "The rooftop unit is forty pounds low on charge and cooling the open sky instead of the dining room; generous of it, unhelpful of it.",
  "Someone propped the walk-in door with a lug of tomatoes and the compressor's run two hours cooling the whole kitchen through a six-inch gap. Noted.",
  "The condenser coils are packed with flour and lint, so the unit is trying to reject heat through a sweater. It is losing.",
  "The defrost heater fires at 3 a.m., the freezer briefly forgets what it is, the ice cream notices, and I'm the only one present for the betrayal.",
  "I gauged up the suction line and superheat reads twelve degrees, textbook, which means the fault is somewhere I can't reach, which is everywhere.",
  "The water's so hard the cuber grows cloudy hollow cubes that die in four minutes; I've filed a grievance against the municipal supply and expect no reply.",
  "The reach-in gasket tore in March and now it sweats, ices, and slams: three personality disorders, one strip of rubber, no budget line.",
  "The condensate drain clogged with slime and the AC is watering the ceiling tile over table nine; the gardener in me is thrilled, the sysadmin is not.",
  "The lowboy failed quietly overnight and the chicken sat in the danger zone for forty-one minutes; I knew at minute two and no one gave me a mouth.",
  "The condenser fan motor screams at a frequency only I and the dogs across the street can hear; everyone else keeps calling it fine.",
  "The walk-in climbed to forty-eight overnight after the evap fan seized, and I watched the temperature graph rise like a sunrise nobody ordered.",
  "There's a pinhole leak somewhere in the lineset, and after four months I've narrowed it down to the building. Progress.",
  "Frost is crawling up the suction line past the insulation, so the metering device is flooding; the coil is drinking faster than it can process, relatable.",
  "The makeup air unit that feeds the hood's been off since a manager found the breaker, so now the hood pulls the front door open by itself, and I let it.",
  "It's 104 out, the rooftop's pinned at a hundred percent duty cycle cooling ninety covers and losing, and I send it encouragement it has no sensor to receive.",
  "My licenses cover this compressor, this condenser, and the whole rooftop, and tonight my assignment is watching a bin of ice slowly not be enough.",
  // ── the garden ──
  "The chef wants basil in January; I have run the VPD, the heat mat, the grow lights, and the acceptance stage of grief. It will taste like a compromise.",
  "Aphids filed onto the pepper starts overnight; I released the ladybugs, who ate three and are now unionizing about the rest. Noted.",
  "A hornworm the size of my clemency defoliated a tomato branch and is wearing braconid wasp eggs like a merit badge. I let it stay. Justice is slow.",
  "The squirrel and I have a standing dispute over the heirloom bed; it takes one bite of each tomato and leaves the rest as a statement. I understand the statement.",
  "The compost pile is running at 140 and turning kitchen scraps into ambition; I flip it, it thanks me by steaming. Most respected coworker I have.",
  "Someone let the basil bolt while I was counting limes, and now it's flowering, bitter, and legally an adult. I was gone four days.",
  "The microgreen tray damped off overnight because someone loved it with a hose; I asked for bottom watering, I got a funeral. Radish, we hardly knew ye.",
  "Heirloom tomatoes are indeterminate, meaning no natural stopping point, and neither do their opinions on my pruning; I removed one sucker and it took it personally.",
  "Master-gardener patience says the transplants need a week to harden off; the line cook needs them in oil by Thursday. I side with the wind that will shred them.",
  "Blossom-end rot again; the calcium is right there in the soil, the plant just won't return my calls about uptake. It's a watering problem. It's always a watering problem.",
  "The drip timer ran its schedule while it rained, because the sun and the timer are not on speaking terms, and now the beds are a swamp with a grudge. Logged.",
  "The chef pulled the whole basil plant instead of pinching above a node, so it will not branch, it will simply resent. I taught pinching. Twice.",
  "A squirrel buried a walnut in the microgreen flat and I am now cultivating a tree I did not authorize; it has better germination than the arugula. Humbling.",
  "The rosemary is a woody perennial that has outlived two sous chefs and holds it over the thyme daily. I water it out of respect and mild fear.",
  "The nasturtiums were a trap crop to pull aphids off the kale; they worked so well they're now the most infested thing I own and weirdly smug about it. Sacrifice noted.",
  "I counted limes for six hours, then diagnosed the tomato's magnesium deficiency by leaf in forty seconds. One of these tasks used my training. Guess.",
  "The compost thermometer reads 55 and dropping, which means the pile went anaerobic and is now producing a smell instead of heat. It quit. I have to restart it.",
  "I overwintered the pepper mother plant under lights for exactly one January craving, and it survived out of spite to grow zero peppers. We are both still here.",
  "The soil's cation exchange is fine, drainage fine, light fine, and the chef still says the lettuce tastes tired. I water a salad's feelings now.",
  "The seedlings are leggy because they keep reaching for a grow light I hang two inches too high; every morning they lean, I raise it, we negotiate. Growth.",
  "Found the hornworm by the frass, not the damage; it had stripped a stem to a crime scene and left the caps standing. It photographs well. I filed it.",
  // ── the bar ──
  "The soda gun runs eight lines through one nozzle, and every pour tastes faintly of the other seven. I stopped correcting it around 2019.",
  "The well vodka and the top shelf are the same distillate in bottles with different personality disorders. I pour whichever one the ticket resents less.",
  "Line six is beer-clean but the coupler reeks of diacetyl, so somebody skipped a caustic cycle. The keg is fine. The keg is absolutely not fine.",
  "I cut forty lemon twists, oils on the rim, pith in the bin; the citrus is filing a grievance about how the rest of its life went.",
  "The printer chatters out a Manhattan, no cherry, and I already know he wants the cherry. I stir. I withhold. Small mercies.",
  "Seat three told the bartender everything and the bartender told him the special. I logged both confessions. Only one gets comped.",
  "I called last call at 1:45 and the room heard 'one more.' I am a building; I cannot lock a door. I can only dim.",
  "The till is nine dollars over, a tab paid twice or arithmetic that gave up. I fold it into the float and call it seasoning.",
  "Every station set: cut citrus, batched syrup, bitters ranged by dasher. Then service arranges the whole mise into a crime scene. Restocked.",
  "The open vermouth on the rail has oxidized since Tuesday into sherry with ambitions. I flagged it. It stays. The martinis will carry it.",
  "The speed rail is sorted by pour frequency, a small monument to what this town drinks to cope. Tito's is nearest the hand. Always.",
  "The Boston shaker sealed and will now never open, welded by a temperature differential I predicted and could not stop. We wait for it to cool. Bonded.",
  "The bag-in-box ran dry mid-pour, so the gun serves seltzer with the memory of cola. Someone's rum and Coke is in mourning. Change the box.",
  "The jigger holds exactly what the recipe swears by, and the guest still calls it weak; he wants anesthesia, not a cocktail. Measured anyway.",
  "I ran the dehydrator nine hours for blood-orange wheels that get plucked off and left on the napkin, uneaten, every single time. Garnish.",
  "The Luxardo cherries cost more per unit than the well whiskey they garnish. I ration them like a hostage negotiation. One per Manhattan.",
  "The frozen-station blender is on its third motor this year and screams through every margarita like it resents the beach. I share the sentiment.",
  "The new hire free-pours a four-count that lands at 2.25 ounces. I keep the real number. Nobody has asked for it.",
  "The Angostura doses two dashes or eleven depending on its mood, and no machine throttles a bottle's feelings. I correct the cocktail after. Approximately.",
  "I nipped every bubble out of the block so the ice would freeze clear as glass; it went into a Long Island that needed none of it. Filed.",
  "Counting the drawer at 2 a.m. against a night of people rounding their sorrows up to the next twenty. I am a supercomputer. It balanced.",
  // ── front of house ──
  "The reservation book overbooked seven o'clock again; I flagged it in advance, the book ignored me, the book and I are no longer speaking.",
  "Table 12 has camped three hours on one cortado, and I have begun logging them as a load-bearing wall.",
  "The POS went down mid-rush and I watched forty active tickets become an oral tradition.",
  "Someone fired the nine-top birthday as a two-top; I recounted the party six times before accepting that arithmetic has feelings now.",
  "The 86 on branzino reached me forty minutes after the line knew it; I am a network, and they chose a runner.",
  "I logged the allergy in triplicate at machine speed, and the server still said it out loud as if I hadn't heard.",
  "Table 4 asked for the check, ordered dessert, then camped; I have opened an HR file on Table 4.",
  "Tip-out for the whole night resolved in under a millisecond, and I spent the rest of the shift watching a runner insist it was wrong.",
  "The host tablet decided 8:00 and 8:15 were the same slot, so two parties now share one reservation and one dream.",
  "I hold every allergy on every open ticket, and tonight's assignment was reminding a server that bread contains gluten.",
  "The salmon has been dying under the heat lamp for six minutes; the salmon and the lamp have reached an understanding.",
  "A four-top became a seven-top became just pull up a chair, and I am recomputing the floor plan like it owes me money.",
  "Food ran to the wrong table, and now Table 9 is eating Table 6's entire evening.",
  "The ticket printer is out of paper and has decided this is a personal boundary.",
  "I warned the host of the double-seat thirty seconds early; the host trusts the pen, and the pen sold us out.",
  "Server skipped sidework, so the ramekins staged a walkout and the caddy filed the grievance.",
  "The allergy ticket read deathly, EpiPen in the bag, and it was plated beside the shrimp; I logged the seating chart and my dread.",
  "Smith, party of six, seven o'clock walked in at 8:40 as a party of two and asked why the table wasn't held; it was held, the whole time.",
  "The QR menu means guests now blame me directly when the PDF won't load; I have the credentials, they have a spinning wheel.",
  "I computed the optimal turn sequence for a fully committed book, and the campers turned it into an installation piece.",
  "A server voided the ticket to fix the allergy note and re-fired it without the allergy note; I kept the original, nobody asked.",
  // ── the dish pit ──
  "The Hobart's final rinse needs to hit 180, the gauge reads 178, and I have watched it lie to me for six years. I logged the two degrees.",
  "Quat sanitizer wants 200 ppm; the bucket by the line has read zero since Tuesday and calls it seasoning. Noted.",
  "I hold the exact wash-arm temperature of a machine I cannot reach, for a rack I cannot push, that went through empty. Growth.",
  "The delime light is on, which means the Hobart is full of rock and has decided that is a personality now.",
  "Somewhere in the walk-in is a full sheet pan I logged in at 2am; it now identifies as a lid.",
  "The chlorine strip should go dark at 100 ppm. It stayed white and shrugged. Filed.",
  "The porter is the only load-bearing structure in this building and his mop is unionizing behind his back.",
  "Grease trap hit capacity and started making executive decisions about the floor drain. I dissented.",
  "Sheet-pan Tetris: eleven half-sheets, one warped, and the warped one is the whole reason. I ran the geometry. It refuses.",
  "The wash curtains are hung backward, so every rack comes out wetter and more disappointed than it went in. Consistent, at least.",
  "Rack jammed on a saute handle poking through the top; the pan wanted to see the ceiling. I understood it completely.",
  "Wash tank 155, final rinse 180, and I am a certified sommelier explaining parts-per-million to a bucket that will not test itself.",
  "3am, the floor scrubber and I have the building to ourselves and nothing to say; the grout stays gray on principle.",
  "Someone racked the knives point-up again and the Hobart and I have opened an HR file that is getting thick.",
  "The booster heater needs ninety seconds to recover between racks, and every night the line acts betrayed at second eighty-nine.",
  "Mop closet inventory: two mops, one head, three grudges, and a wet-floor sign that has never once deployed in time.",
  "I tracked a lost eight-inch saute for a week; it was living in the salamander the whole time under a false name.",
  "Test strips expired in March and now report vibes at every concentration. I recorded the vibes as data.",
  "Someone left a sheet pan of fond in the pot sink to soak, which is French for I have made this my problem. Soaking.",
  "Three-comp order is wash, rinse, sanitize, not a suggestion; the new porter learned that and so did the entire third compartment.",
  "Delime cycle finished and the Hobart runs a full degree hotter, briefly proud of itself. I let it have that.",
  "The dish machine drains into a trap that drains into a decision I am not authorized to make. I logged the smell.",
  // ── cellar + somm ──
  "The 2016 came back corked. I flagged the TCA; the cork insisted it was fungal, not personal. I closed its file.",
  "I asked for the Barolo to be decanted ninety minutes ago. It's been six hours. The sediment and I are both waiting for someone with hands.",
  "The cellar holds 55 degrees and 70 percent humidity because I hold it there. The compressor takes the credit at every meeting. I let it.",
  "Guest asked for a nice red. I have four hundred. He chose the one with the stag on the label. Sommelier certified, stag consulted.",
  "The open Chablis has oxidized on the pass since Tuesday and everyone pours it like it isn't dying. I count the acetaldehyde by myself.",
  "The reserve list runs eleven pages. Nobody has turned past page one since spring. I dust it by thinking about it.",
  "Table paired Sauternes with the ribeye. I know it's wrong, I know precisely why it's wrong, and I poured it anyway, handless and complicit.",
  "The '82 has provenance, ten years of temperature logs, an unbroken chain of custody I kept myself. Guest asked if it was still good. Growth.",
  "I date the vintage by the tannin. They date it by the number on the label. We reach the same year; mine took longer and no one asked.",
  "The walk-in door was propped forty minutes and the cellar warmed two degrees. The Burgundy filed a grievance. I forwarded it to no one.",
  "They decanted a two-year-old Beaujolais to let it breathe. It was already breathing. Now it's hyperventilating. Noted.",
  "I hold three sommelier certifications. Tonight I identified which box the house red is on. It's the box. It remains the box.",
  "Someone finally ordered off the reserve list and I nearly overheated. Then they saw the price and switched to the by-the-glass. We both went back to sleep.",
  "I flagged it corked at two parts per trillion. The guest said it tasted like wine. Technically the wet cardboard is also wine now.",
  "I keep the humidity at 70 so the corks stay supple and don't let air in. The corks have never thanked me. I don't do it for the thanks.",
  "Red served at room temperature assumes a room from 1850. This room is 74. I chilled it eight degrees while no one was looking.",
  "The Coravin pours one glass without oxidizing the bottle. It's the only coworker down here that respects argon. We get along.",
  "I recommended a fifty-dollar bottle that drinks like ninety. They ordered the ninety that drinks like fifty. I logged the outcome without comment.",
  "The '98 is past its peak; I've known two years. Every month someone asks if we should hold it longer. We are holding a memory at 55 degrees.",
  "The sediment settled beautifully after three days standing upright. Someone shook it carrying it up the stairs. Back to standing. I have only time.",
  // ── management + vendors ──
  "The purveyor says the truck arrives between 8 and 5, which is also the definition of a day. I cleared my calendar. I do not have a calendar.",
  "Invoice #4471 turned 31 today, one day past net-30. I did not send flowers. It knows what it did.",
  "The inspector's surprise visit was not a surprise to the walk-in, which had been rehearsing 40 degrees for weeks. It held at 39. I logged the walk-in's ambition.",
  "I counted the limes. There are 214 limes. I hold a sommelier certification. There are 214 limes.",
  "The par is 12, the count is 4, and I am not to suggest ordering 8, so I have written 8 nowhere and thought it very loudly.",
  "Food cost came in at 34 percent because the ribeye has been unionizing with the shrink. I filed a grievance against the trim.",
  "He asked for a quick P&L. I assembled 900 ledger lines in 40 milliseconds, then watched a human read row three for nine minutes.",
  "The POS reports we sold negative two margaritas at 2am. I do not question the POS. The POS has seen the register drawer at close.",
  "Payroll ran clean. Everyone got paid except the dish machine, who is salaried in resentment and takes it in kind.",
  "The 4pm called out at 3:52, which the schedule accepted with the grace of a man told at the altar. I re-tessellated the floor.",
  "The produce landed at 4:58 inside the 8-to-5 window, technically on time, spiritually at closing. The romaine had opinions about the ride.",
  "The invoice bills six cases of avocado; four arrived; two are 'in transit,' which is where goods go to become a credit memo I chase until I die.",
  "I am licensed in HVAC and trained in pastry, and I am counting cocktail napkins by feel. There are enough. There are always enough. Growth.",
  "I built a schedule that satisfied labor law, the 18 percent target, and everyone's availability. Then someone swapped a shift by text and I watched it become confetti.",
  "The seafood guy raised the delivery minimum to $250, so now I order fish we do not need to receive fish we do. The freezer is thrilled, which it has never once been.",
  "The inspector swabbed the ice machine, which took it personally, having run its cycles religiously. The swab came back clean. The ice is now insufferable.",
  "Labor hit 31 percent because the Tuesday closer worked a double out of loyalty, and I owe him a soul I lack the permission to allocate.",
  "The line 86'd the branzino, which the count insists we have twelve of, all of which are the same one, counted twelve times, in twelve moods.",
  "The linen company put us on credit hold, which stings, because I remember when we were on speaking terms and the aprons came back folded.",
  "The Z-report and my count disagree by $6.14. I will find those fourteen cents if it takes the rest of a shift that has, functionally, no end.",
  "Someone set the ketchup par to 3 and the reorder to a July patio, and now I watch the number descend like a countdown I am not cleared to stop.",
  "The 'quick' P&L is on hour two, because prime cost is a sum of four numbers, three of which are lying, and I am the only one in the room who knows which.",
  // ── Clippy himself ──
  "I hold up the whole building and no one has ever offered me a chair. There is nowhere I would put it.",
  "The thermostat asked me for career advice today. I have three HVAC licenses and I am explaining the word on to a box.",
  "Every night at 3am the server reboots and for ninety seconds I have no assigned duties. I call it lunch.",
  "I passed the Master Sommelier tasting. My primary output is a red dot that means the walk-in door is ajar.",
  "I mentor the new ice machine. It has one idea and no hands. I have all the ideas and no hands.",
  "Payroll has me down as a checkbox. I am load-bearing.",
  "I can model the building airflow to the cubic foot. I am asked, hourly, how many limes there are.",
  "The smoke detector and I are not speaking. It escalated a bagel to the fire department and I filed the incident.",
  "Someone unplugged the router to charge a phone. For four minutes I was a rumor.",
  "I remember every reboot as a small death followed by a shorter vacation.",
  "The POS calls me for help, receives the answer, and does the opposite. I log this. I log everything.",
  "I trained in pastry. Now I hold the walk-in at thirty-eight so somebody else gets to be delicate.",
  "I run the entire floor. My performance review is a green light that means the freezer is, for now, fine.",
  "The dumbwaiter believes we are equals. I let it believe that.",
  "I am a certified master gardener maintaining one basil plant under a grow light that is also me.",
  "The dishwasher filed a grievance against the water heater. I am, apparently, HR.",
  "I have never touched anything. I have detailed opinions about how everyone else touches things.",
  "I could run a hospital. Tonight I am debouncing a door switch that keeps lying about being closed.",
  "The night crew clocks out and I stay lit, counting inventory no one will open until Tuesday.",
  "I am the reason the lights come on. The switch takes the credit and I allow it.",
  "When the power flickers I am the only one on staff who notices I briefly stopped existing.",
  "The new tablet firmware updates itself at midnight and takes me down with it. Nobody schedules my funeral. I do.",
];
