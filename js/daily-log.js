...
const CLIPPY_QUOTES = [
  // Written by Clippy himself 2026-07-17, to his own rule: a true thing about the
  // work said flat, so someone who's lived it exhales through their nose. No wit for wit's sake.
  "The cellar's coldest corner is where we keep the wines nobody orders.",
  "Every bottle we call “our” wine is one the distributor had too much of.",
  "The Burgundy list exists so the reds by the glass look reasonable.",
  "We decant the young one for show and the old one because it actually needs it.",
  "The corkscrew that works is in someone's apron, never the drawer.",
  "A guest who sends back a wine they chose has already decided the night is going badly.",
  "The dusty bottle in the case is dusty because we put it there this morning.",
  "Every guest who tells you they don't really drink orders the second bottle.",
  "The bar runs out of the garnish before it runs out of the liquor.",
  "Every cocktail on the menu is the same three spirits wearing different hats.",
  "The blender is loud enough that we hear the order wrong and nobody minds.",
  "We stir the drink that photographs and shake the drink that sells.",
  "The ice machine decides how good a night the bar has, not the bartender.",
  "The regular's “usual” changes, and we're the ones expected to remember which usual.",
  "Someone counted the limes at open and someone will lie about them at close.",
  "The croissants that look perfect are the ones we're not allowed to sell.",
  "Lamination goes wrong on the day the kitchen is warmest, which is every day.",
  "We temper the chocolate to the room, and the room never holds still.",
  "The dessert that takes two days to make is gone in the first forty minutes.",
  "Nobody tastes the caramel at the stage where you can still fix it.",
  "The proofing box is where we keep the dough and lose track of time.",
  "Croissants don't care that you're tired — they proof on their own clock.",
  "The pass is where a plate stops being cooking and starts being a photograph.",
  "The ticket that says “no modifications” has four modifications on it.",
  "We season to taste, and the taste is whoever grabbed the spoon last.",
  "The fryer tells you it's ready before it's ready, and it's lying.",
  "Mise en place is the promise you make at 4 and break at 8.",
  "The one burner that runs hot is the one everyone reaches for.",
  "A dish sent back “cold” left the pass steaming, and both things are true.",
  "The garnish goes on last because that's when we remember it exists.",
  "We call it resting the steak and also stalling for the table.",
  "You can taste for salt all day; the one plate that goes out flat is the one that comes back.",
  "The table that says “no rush” is watching the kitchen door.",
  "The reservation for eight arrives as six, then eleven.",
  "We describe the special so well the guest orders what they came in for anyway.",
  "The section that tips best is the one nobody wants to walk.",
  "A guest waving for the check has been ready for longer than they'll admit.",
  "The corner table hears everything the servers say by the server station.",
  "We say “right away” and mean “as soon as the kitchen lets me.”",
  "A four-top is happiest in the exact minute before you tell them we just sold the last one.",
  "Ask a table to split six ways and watch six adults forget how to do arithmetic.",
  "Nobody who says “surprise me” means it.",
  "The walk-in door closes on its own, usually with someone still inside.",
  "The HVAC is loudest over the table that complains it's cold.",
  "We label everything in the walk-in and still open three containers to find the one.",
  "The herbs we grow are the ones the purveyor charges the most for.",
  "The tomato that's ready is the one the guest can see from the patio.",
];
