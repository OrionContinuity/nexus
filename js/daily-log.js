...
const CLIPPY_QUOTES = [
  // Written by Clippy himself 2026-07-17 — longer, with a punch: the craft builds,
  // then the truth turns. His own rule, his own lines.
  "We chart the cellar by vintage and region and provenance, three hundred bottles logged to the gram — and the table of six who asked for \"something bold, surprising, you choose\" wanted, it turns out, the second-cheapest red.",
  "The sommelier can name the soil the grapes were grown in and the year it last rained there, can decant a Barolo like defusing a bomb — and the bottle that moves fastest is the one whose label has a kangaroo on it.",
  ...
  "We keep the ullaged bottles, the corked returns, the museum verticals nobody dares open — a whole shelf of history — and the by-the-glass that pays the rent is a Pinot Grigio we buy in a box we hide.",
  ...
  "Every stool at the bar is a different problem, and we learn them fast: the talker, the crier, the one on a first date going badly — and the best tipper of the night never says a word and drinks tap water.",
  ...
  "Pastry is up before the ovens, laminating in a walk-in so the butter won't turn, counting folds like a rosary — and the dessert that outsells everything is the one plate we call \"just chocolate\" because we ran out of ideas naming it.",
  "She tempers the chocolate to the half-degree and it snaps like a promise — and the table sends it back not too sweet, not too bitter, but because someone at it is \"being good,\" which no oven has ever fixed.",
  "We plate the soufflé in the ninety seconds it has to live, sprint it through the pass like it's on fire — and it sits at the table photographed and cooling while the guest finishes a story about her flight.",
  "The pastry section is the only calm one at service, quiet and floured and precise — right up until a four-top decides at 10:55 that actually, yes, they do want to see the dessert menu.",
  ...
  "The line runs on a language of numbers and elbows and \"behind,\" a whole grammar shouted over the hood — and the longest ticket of the night, the one that breaks the rhythm, is a well-done ribeye \"however the chef likes it.\"",
  "We hold four proteins at temperature and fire them to land together, the whole station a held breath — and the table that ordered them sends one back because it \"came out hot,\" which is, structurally, the promise.",
  "Every cook on the line has burned themselves so often the scars are a résumé — and the injury that actually ends a shift is a wet floor and a clean pair of shoes near the walk-in.",
  "We taste the sauce, adjust, taste again, chase a seasoning we could find blindfolded — and the plate comes back for more salt from the one table that ordered everything without any.",
  "Mise en place is a religion, every container squared and full before the doors, an hour of quiet devotion — and the run that empties it in one seating is a Tuesday nobody staffed for, because Tuesdays are supposed to be safe.",
  ...
  "We memorize forty covers of allergies and anniversaries and who's proposing at the window — a whole evening held in the head — and the one detail that decides the night is whether the table by the door felt a draft.",
  "A server learns to read a table in three seconds flat: the rushed, the celebrating, the couple not speaking — and the two-top that lingers three hours, blocking the turn, leaves the warmest note the restaurant has ever gotten.",
  ...
  "We built the room so nobody notices the room — the temperature, the pacing, the pane that keeps the street out — and the only feedback all night is that the table wobbled, which we knew, and had fixed, an hour before they sat.",
  "The walk-in is a museum of labeled restraint, everything dated and rotated, FIFO like scripture — and the thing that spoils is the herb nobody logged because it was \"just for garnish,\" which is now the whole reason a dish is 86'd.",
  "We nurse the HVAC through August like a sick animal, know every rattle in the ductwork by name — and the night it finally dies is not the packed Saturday but the empty Monday, out of what can only be described as spite.",
  "The garden gives us exactly what it wants to give, on its own schedule, indifferent to the menu we printed — and the basil comes in glorious and endless the same week the tomato it was born to sit beside gives up entirely.",
  "We chase the perfect walk-in temperature to the degree, guard it against every open door — and the item that turns first is the one a cook left out for \"just a second\" that became the length of an entire Saturday service.",
];
