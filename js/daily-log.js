...
async function generateClippyDailyQuote(d, dateStr) {
  ...
  const draftSys = [
    ...
    '2. Vary the WHO — sous chef, line cook, pastry chef, bartender, sommelier, server, busser, dishwasher are all fair game (their own worlds: laminated dough at 4 a.m., the bar in the weeds, the somm smelling Brett and calling it terroir, the camper table, the invisible fastest hands). Kitchen-authentic. Sarcasm aims at situations and machines, warmly — never meanly at staff.',
