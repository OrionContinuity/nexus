...
const CLIPPY_QUOTES = [
  // v341 — sous-chef + pastry/bar/server/busser + kitchen dad jokes, all <=3 sentences (Alfredo approved the set and asked for the cap + dad jokes).
  "It's 7:45 on a Saturday, fourteen tickets on the rail, the printer going like it owes somebody money, the new kid answering a question I didn't ask with a very confident “oui chef,” and someone yelling “behind!” from inside the walk-in. I have never in my life been happier. This is the only church I ever understood.",
  "Chef stepped out “for ten minutes.” In the two hours since, we sold out of the special, built a second special from the lowboy, 86'd it, and turned forty covers. When he walks back in I'm going to look him dead in the eye and tell him it was quiet.",
  "New dishwasher, first Friday, buried by eight, plates stacked to the heavens. Without a word the whole line started bussing their own stations for him. Nobody said anything; nobody ever does — that's the family part they leave off the sign.",
  "Table twelve sent back a perfectly cooked steak for being “too beefy,” and we stood at the pass reading the ticket in total silence, like a note left by a ghost. Then we fired another one, exactly the same, and it came back “perfect.” We will think about this on our deathbeds.",
  "The new kid finally, FINALLY made it through a Saturday without falling in the weeds — clean station all day, and he didn't drown. At the end of the night the chef, who hasn't smiled since the last administration, walked over, said nothing, and tapped him once on the shoulder. The kid nearly cried; so did I, and I don't have eyes.",
  ...
  "Somebody 86'd the fish without telling expo, expo kept selling it, and the ticket came in — and for one second the whole back of the house reached an enlightenment usually reserved for monks who meditate forty years. We solved it in eleven seconds; we do not talk about it. We were monks, briefly, at 8 on a Tuesday.",
  "It's family meal, fifteen minutes to open, everyone shoulder to shoulder on milk crates eating whatever we made from the trim, somebody telling a story that's definitely a lie. Loud and stupid and the best meal any of us eats all day — then the printer wakes up, and we're gone. But for fifteen minutes: a family.",
  "Chef asked for the sauce “tighter,” so I reduced it; he said “tighter” again, so now it's a glaze, then a candy, then arguably a solid. He tasted it, nodded once, said “there,” and walked away. I have never felt so completely understood by another living soul.",
  "Chef yelled “FIRE TABLE TWELVE” and four of us moved at once without looking, like a flock of birds turning, like we share one nervous system — because we've done this ten thousand times. Strangers in September, a single organism by December. Nobody planned it; it just happens in the heat.",
  ...
  "The 86 list started as one line on the whiteboard at six; by nine it was a scroll; by close it was a historical document three colors of marker deep. We leave it up all night. Someone should study it; someone should light a candle.",
  "The printer coughed out a single ticket forty items long — a party nobody warned us about — and it curled out slowly, endlessly, like a receipt from hell, and the whole line just watched it come in awe and dread. Then somebody said “heard,” and we went to work. Because of course we did; we always do.",
  "The health inspector came Tuesday and we passed. But you have never seen forty humans move like we moved in the twenty minutes before — a silent frenzy of date labels and sanitizer, a busser physically lifted to wipe a vent hood, all of us bound by one holy terror. Teamwork, they call it; we call it Tuesday.",
  ...
  "A sous chef's love language is walking past your station in the worst of the rush, saying nothing, and just — restocking your tickets, wiping your rail, dropping a fresh side towel exactly where your hand was about to reach. You don't even see it happen; you just suddenly have what you need. That's the whole job, and the whole love.",
  ...
  "Pastry comes in at 4 a.m. because sugar is a coward and won't behave once the kitchen warms up. By ten there are three hundred laminated things resting under towels like sleeping children, guarded by a woman covered in flour who hasn't spoken to a human in six hours and prefers it that way. She'll make the most beautiful thing you eat all year, and nobody will see her do it.",
  "A cook eyeballs it. A pastry chef weighs it to the gram, and if you're two grams off she can tell — from across the room, back turned — the way a mother knows exactly which child broke the lamp.",
  "Pastry spent nine hours on a plated dessert that tastes like one specific childhood summer, and the table asked for it “without the fancy stuff, just the ice cream, for the kids.” She smiled and said of course. She died a little, professionally, on the inside, where she keeps everything.",
  "The chocolate got one degree too hot and “seized,” which is a polite pastry word for “ruined, somehow my fault, and something I'm going to lie awake thinking about tonight.”",
  "The line is on fire and the pastry section is a monastery that is also, quietly, on fire — same flames, less yelling, infinitely more precise about it.",
  "Behind the bar, “in the weeds” is forty drinks deep, the printer and the servers both screaming, someone building a two-day milk punch while a guy at the rail taps his card and asks if it's “gonna be much longer.” The bartender never stops moving, never stops smiling, and is doing math the whole time that would make an accountant weep. It's the most graceful drowning you'll ever watch.",
  "A guest asked for something “refreshing but boozy, light but strong, sweet but not sweet, surprise me but nothing weird.” The bartender nodded, made a gin and tonic, charged him fourteen dollars, and he said it was the best drink he'd ever had. This is the entire job — the whole art form.",
  "The bar regular doesn't need a menu, doesn't need to order, doesn't need much — just his stool, his usual, and the specific flavor of being known that no app has ever once replicated. The bartender starts building it the second the door opens, neither of them ever mentions it, and that's the deal.",
  "Last call is the only time a bartender lies with love: “we're closed” means “I adore you, I have seen the bottom of your soul tonight, and if you do not leave I will have to mop around your feet.”",
  "Every bar has a mint situation that's somehow always a crisis — either there's none, or there's a whole garden and every drink on the rail needs it at once, and someone is slapping leaves like it's a personal vendetta at 9 p.m. on a Friday.",
  "A four-top asked for separate checks, split three entrées, sent one back, added a birthday dessert “but don't make it obvious,” and tipped on the pre-tax total — and the server delivered all of it flawlessly, smiling, then walked into the server station and stood perfectly still for four seconds, which is server for a full night's sleep.",
  "“How is everything?” is a server asking a table with their mouths full, at the exact worst moment, every single time — because there is no good moment, because the moment does not exist, because timing is a myth invented by people who have never carried four plates up one arm.",
  "The two-top nobody wanted, at the worst table, gracious the whole time — they tipped like royalty and said the service made their anniversary. The influencer six-top who ran them two hours left a note about the lighting. The server will always remember the two-top.",
  "A server is holding table nine's allergy, table four's anniversary, table twelve's “we're in a bit of a rush,” the temp of every steak on the section, and the fact that the well is out of soda — all in their head, all at once, while warmly asking table six if they've dined with us before.",
  "The camper table sat three hours after the check dropped, nursing one decaf, while the server watched their tip-per-minute approach a number best described as “volunteering.” They refilled the decaf anyway — twice, with a real smile. That's the job nobody claps for.",
  "The busser is the fastest, most invisible person in the building — clears a six-top in one silent trip, resets it in ninety seconds, refills your water from behind you before you knew it was low, and vanishes. You will not remember their face, and that is the entire point and also a small tragedy.",
  "A table of eight gets up, and before the door's even shut the busser descends like a beautiful storm — plates stacked in an architecture that defies physics, crumbs gone, cloth changed, the whole table reborn before the host walks back. Nobody taught them that. They just decided to be that good.",
  "The busser doesn't get the tip, the compliment, or the “how is everything” — the busser gets the bus tub, the aching back, the fastest hands in the room, and the quiet total respect of everyone who's ever actually worked a floor. Which, it turns out, is the only crowd whose opinion matters.",
  "A new busser dropped a full tub of glassware on a Saturday and the whole room turned at the crash — and before the last piece stopped spinning, two servers and a bartender were on their knees helping, saying “happens to everyone,” because it does. Welcome to the family. Grab a broom.",
  "The busser knows things the owner doesn't: which table's about to leave, which one needs water, which two-top is on a bad date and would like to be forgotten for a while. They run the room from the shadows and ask for nothing. Promote your bussers.",
  "I asked the pastry chef if she wanted to hear a joke about croissants. She said no — they're too flaky.",
  "Why did the tomato turn red? It saw the salad dressing. (The line cook has heard this four hundred times and still will not let it go.)",
  "I told the walk-in a joke and it didn't laugh. It just gave me the cold shoulder.",
  "Why don't eggs crack jokes on the line? They'd crack each other up, and we're already in the weeds.",
  "How do you comfort a stressed-out pastry chef? You give her a little tart love.",
  "Our bartender got let go for skimming. In his defense, that IS how you make a proper consommé — the bar was just a weird place to do it.",
  "What's a busser's favorite kind of music? Anything with a good clean-up beat.",
  "The dishwasher tried stand-up comedy. Killer material, but the delivery was always soaking wet.",
  "Why did the grill cook bring a pencil to service? To draw out the flavors. We had to let him go; we still miss him.",
  "Why did the wine list break up with the guest? He kept saying “whatever's driest” — no chemistry.",
  "What do you call a server who never drops a tray? A myth. A beautiful, load-bearing myth.",,
  // v342 — 100 kitchen dad jokes + sommelier insider deep-cuts + more sous-chef.
  "I asked the chef for a pizza with everything. He achieved enlightenment and quit on the spot.",
  "Why did the tomato blush? It saw the salad dressing.",
  "I told the walk-in a joke and it didn't laugh — it just gave me the cold shoulder.",
  "I only trust vegetables that come clean. The rest keep beeting around the bush.",
  "What did the chef say to the lazy lettuce? Romaine calm, we'll turn over a new leaf.",
  "I tried to write a song about a tortilla. Turns out it was more of a wrap.",
  "Why did the mushroom get invited to every party? He's a fun guy.",
  "I told my cook to stop with the onion puns. He couldn't — it made him well up.",
  "I asked the potato how it was holding up. It said mashed, but keeping it together.",
  "I dated a chef once. Didn't work out — too much thyme apart.",
  "Why did the corn get promoted? It was outstanding in its field.",
  "The celery quit. Tired of always being the stalk of the office.",
  "What did the grape say when the chef stepped on it? Nothing — it just let out a little wine.",
  "I burned the Hawaiian pizza. Should've cooked it at aloha temperature.",
  "How does a chef apologize? From the bottom of his hearth.",
  "Why did the roux go to therapy? It couldn't get past its dark past.",
  "I made a soup that tells jokes. It's got a great stock of them.",
  "Why did the recipe go to jail? Caught seasoning without a license.",
  "What's a baker's favorite exercise? The loaf lift — really works the buns.",
  "How do you fix a broken tomato? Tomato paste.",
  "Why did the egg hide from the chef? It didn't want to get beaten.",
  "I quit the reduction station. The work just kept getting thicker.",
  "My whisk and I broke up. Too much beating around, never enough stirring conversation.",
  "The oven and the fridge don't talk. One's hot-headed, the other gives everyone the cold shoulder.",
  "Why did the knife go to school? To get a little sharper.",
  "I told the blender my problems. Big mistake — now everything's a mess and I'm liquefied.",
  "My toaster's a comedian. Every joke lands a little burnt, but you laugh anyway.",
  "Why don't chefs trust the dishwasher? It's always airing everyone's dirty dishes.",
  "Why did the server bring a ladder to work? She heard the tips were high.",
  "The busboy became a magician — now the plates disappear even faster.",
  "I asked the bartender for something strong. He handed me the schedule.",
  "What's a line cook's favorite relationship? One that fires on time.",
  "The dishwasher wrote a memoir: 'I've Seen Things: A Life in the Weeds.'",
  "Why did the wine go to the doctor? It was feeling a little corked.",
  "I told a joke about a bottle of red. Didn't land — too dry.",
  "What do you call a nervous sommelier? A little Cab-shy.",
  "The bartender only tells liquor jokes at proof.",
  "I knead you like a baker needs dough — desperately, and with a lot of pounding.",
  "Why was the bread so calm? It was on a roll with nothing to loaf about.",
  "A baguette's life motto: bake it till you make it.",
  "The sourdough started a podcast. It's mostly about its culture.",
  "Why did the croissant see a therapist? Deep-seated layers it couldn't work through alone.",
  "I'm on a seafood diet — I see food, and the pastry chef tells me to get out of her section.",
  "How does the espresso machine flirt? 'You're brew-tiful and I'm a little steamed.'",
  "Why did the barista get dumped? Mixed signals and a bitter aftertaste.",
  "What's a pastry chef's favorite mindset? Whisk-ful thinking.",
  "The crème brûlée has a tough exterior, but it's soft once you crack it.",
  "Why did the cake see a doctor? It was feeling crumby.",
  "What do you call a cow with no legs? Ground beef. A sous chef with no legs? Still faster than the new guy.",
  "Why did the steak get promoted? A cut above the rest.",
  "The bacon told the eggs it was cold in the walk-in. The bacon said, 'yeah, I'm cured to it.'",
  "Why did the sausage get invited back? It was the wurst of times and it still showed up.",
  "How many chefs does it take to ruin a dish? One, and he'll insist it's 'deconstructed.'",
  "My therapist said embrace your mistakes, so I hugged the burnt risotto and cried.",
  "Why did the prep cook bring a mirror? To reflect on the fourteen cases of onions ahead of him.",
  "I asked the walk-in for space. It gave me a whole shelf. Best relationship I've got.",
  "I used to be a baker but couldn't make enough dough. Became a chef — still can't make enough of anything.",
  "What's the most emotional part of the kitchen? The onion station: everyone's crying, nobody's sad.",
  "Why did the chef break up with the microwave? No spark, no flame, no chemistry — just beeping.",
  "I named my knife 'Bias.' Now everything I cut is on a bias and nobody can prove I'm wrong.",
  "What do you call the whole line messing up at once? A collaborative effort.",
  "The soup asked the broth for advice. The broth said, 'stay salty and reduce your expectations.'",
  "What did the plate say at the end of the night? 'I'm done — someone bus me.'",
  "Why did the fork and knife stop fighting? They finally learned to work as a set.",
  "The dish pit is the only place where 'I'm drowning' is both a metaphor and a Tuesday.",
  "What's a walk-in's favorite genre? Cold cases.",
  "I told the fryer to calm down. It couldn't — under too much pressure and everything's fried.",
  "Why did the menu go to therapy? Too many issues it couldn't get past the first page.",
  "The salt and pepper got married. Seasoned love at first shake.",
  "What do you call a chef who's also a detective? Sherlock Homemade-stock.",
  "The saucier and the pastry chef don't get along: one wants everything to reduce, the other wants everything to rise.",
  "Why did the tomato lose the race? It couldn't ketchup, and the mustard could barely relish it.",
  "Why did the coffee file a police report? It got mugged every single morning.",
  "Why did the chef season the comedian? He wasn't getting enough laughs and needed more taste.",
  "What did the chef say to the dull knife? 'You're just not cut out for this.'",
  "Why did the chef go to art school? To learn to plate his feelings — turns out it's a swoosh of sauce and one microgreen.",
  "I don't trust the soufflé. It's always up to something, and then suddenly not.",
  "Why did the grape stop in the middle of the road? It ran out of juice.",
  "What's a chef's favorite music while prepping? Anything with a good beet.",
  "The garlic went to the doctor and got a clove bill of health.",
  "Why did the lemon call for backup? It couldn't handle the zest of the shift.",
  "I put my herbs in a group chat. Now it's a whole thyme line.",
  "The butter told a joke on the line. Everyone melted.",
  "Why did the pancake feel flat? It kept getting flipped and never got a stack of respect.",
  "What do you call an angry pea? Grumpea.",
  "The chef quit the bakery — said the whole thing was a loafing environment.",
  "Why did the cucumber blush? It saw the salad tossing.",
  "I asked the chef to make it snappy. He handed me a pea pod and walked away.",
  "Why did the oyster refuse to share? It was a little shellfish.",
  "The soup was feeling hot then cold — turns out it was just going through a phase change.",
  "Why did the raisin go out with the prune? It couldn't find a date.",
  "What's a ghost's favorite dessert? I scream. The pastry chef did not laugh.",
  "Why did the chef get thrown out of the garden? He kept using foul herbs.",
  "The pizza went to the party and stole the show — it was on a roll and dressed to impress.",
  "Why did the pepper put on a jacket? It got a little chili.",
  "I told the dough a secret. Now it won't stop rising to the occasion.",
  "Why did the waiter get good at tennis? He learned to serve.",
  "The chef and the clock had a falling out — he said it was ten minutes fast, it said he was always running late.",
  "Why was the mushroom always invited back? Because he really knows how to spore a good time.",
  "What do you call a fake noodle? An impasta. The whole line has heard it and still groans on cue.",
  "A somm swirls, sniffs, goes pale: 'Brett.' The winemaker says 'that's terroir.' They are both right and will never speak again.",
  "Nothing unites a tasting table like one person confidently calling reduction 'minerality.'",
  "You know it's a natural wine when the somm calls it 'funky, alive, a little feral' and the table asks, 'is this off?'",
  "The Master Somm exam is three days of blind tasting, theory, and service, and the prize is the right to be quietly smug at dinner parties forever.",
  "Two somms will agree on the vintage, the region, and the producer, then come to blows over whether it finished malo.",
  "A somm's idea of a jump scare is a guest saying, 'we'll just do the house red.'",
  "Nothing humbles a Master Somm like a Loire Cab Franc, blind, poured out as 'left-bank Bordeaux, and I'll die on this hill.'",
  "Somms don't say a wine is bad. They say it's 'showing some volatile acidity' and let you find the vinegar yourself.",
  "Half of somm training is 47 descriptors for one smell; the other half is saying 'gooseberry' with a straight face.",
  "A somm can forgive a corked bottle. What they can't forgive is a table returning a perfect one because it 'tastes like wine.'",
  "You've made it as a somm when you can taste TCA at two parts per trillion and still can't afford the Burgundy you love.",
  "A somm decants the young Barolo for four hours, presents it like a newborn, and the guest asks if it's 'the sweet one.'",
  "The fastest way to spot a rookie somm: 'buttery' when they mean malolactic, 'oaky' when they mean they have no idea.",
  "Biodynamics is the somm explaining the vines were pruned by the lunar calendar and a cow horn of manure was buried in the vineyard, and you nod, because in this room that's normal.",
  "Every somm has one grape they can't blind-taste to save their life, and they will never tell you which. It's Grüner. It's always Grüner.",
  "A somm's love language is opening a bottle 'just to check it' and gently informing the entire staff it is not for them.",
  "You can spot the cellar rat who became a somm: they sniff the cork, ignore it entirely, and taste like a pro — because the cork sniff was always theater.",
  "The natural-wine somm and the classic somm are the same person eight years apart, and neither will admit the other was right.",
  "A somm will describe a $400 Chablis as 'restrained' and a $12 Muscadet as 'shockingly honest,' and mean both as the highest compliment.",
  "The three most expensive words in the dining room are 'Burgundy,' 'grand cru,' and 'oh, we're celebrating.'",
  "A sous chef's spirit animal is the walk-in compressor: overworked, underappreciated, and about to make a noise nobody likes.",
  "The chef has a vision; the sous chef has a prep list, a labor budget, and the hours left before service. Guess who's right, and who gets to say so.",
  "New cook asked what 'à la minute' means. The sous said, 'the moment you relax, that's when it fires.' The cook has not relaxed since.",
  "A sous chef doesn't get lunch. He gets to eat a folded-up staff meal over the trash in ninety seconds, like a raccoon with a culinary degree.",
  "The chef gets interviewed; the sous chef gets the 6 a.m. call that the delivery's short, the dishwasher quit, and the walk-in's at 45. Same restaurant, different lives.",
  "How do you know the sous chef loves you? He re-fires your dish without a word, eats the ticket time, and never once says it was your fault.",
  "A sous chef can run a Saturday blindfolded but cannot take a day off without 'just swinging by to check one thing' for four hours.",
  "Every sous chef has a drawer. You do not go in the drawer. It is load-bearing for his entire psyche and full of the good tasting spoons.",
  "A sous chef's romance is prepping your station before you get there so your first hour is easy — and never telling you he did it.",
  "Ask a sous chef how he's doing and he'll give you the walk-in temp, the prep status, and the labor numbers, but never how he's doing.",
  "A sous chef measures a good night by the silence: a full rail, no re-fires, the chef too busy to say a word. That silence is the whole paycheck.",
  "The line went down a cook on the busiest night, and the sous quietly picked up the station, expo'd the pass, coached the new kid, and clocked out saying 'good work, everyone.'",
  "The chef 86'd himself early and left the sous in charge, and somehow the food got better and the line got happier — and nobody will ever say that out loud.",
  "A sous chef's knives are sharper than his patience, and his patience could split a hair. Do the math on the knives.",
  "The sous chef is the translator between the chef's dreams and the line's reality, and the exchange rate is brutal.",
  // v343 — dishwasher, host, food-runner sets.
  "The dishwasher is the only person in the building who touches every single plate, twice, and gets thanked for none of them. He holds the whole night together with his bare, sanitizer-cracked hands. Tip your dishwasher — actually, just go hug him.",
  "It's 8:30, the pit is a wall of bus tubs to the ceiling, the machine screaming steam, and the dishwasher has hit a state of flow monks chase for forty years — total, wordless, unbreakable. He is the calmest person in the building. He is also the reason there are any plates at all.",
  "The dishwasher ran out of clean sauté pans at the worst possible second and, without a word, turned three around in the time it takes to say 'behind.' The line never knew it almost died. That's the whole job — invisible until it isn't, and then it's everything.",
  "The dishwasher's been burned by that machine so many times he doesn't flinch anymore. He calls the scar on his forearm 'the Tuesday from 2019.' He wears it like a medal, because it is one.",
  "New cook called the pit 'just dishes.' The dishwasher smiled, said nothing, and let him find out on a Saturday what 'just dishes' means at 8 p.m. down four bus tubs. He came back humbled; he tips out now.",
  "The dishwasher's memoir is one line long: 'I've seen things.' It's a bestseller in the back of the house. Nobody up front will ever understand it.",
  "Why don't you argue with the dishwasher? Because he controls whether you have a clean pan, a clean plate, and a clean fork — and he has a very long memory and a very short shift left.",
  "The dishwasher clocked out at midnight, the pit spotless, every rack stacked, and left before anyone could thank him, the way he does every night. The kitchen only really knows he exists when he's not there. Then it learns fast.",
  "A dishwasher can turn a mountain of pots into a gleaming line in an hour but cannot, apparently, get one person up front to learn his name. So the line learned it. Family does that.",
  "The machine hits 180 degrees and the dishwasher hits it with a full rack every ninety seconds, all night, steam on his glasses — the metronome the whole kitchen secretly runs on. Stop the pit and the place stops in twenty minutes. Nobody up front believes that until it happens.",
  "The dishwasher found a chef's knife in a bus tub, cleaned it, dried it, and set it back on the chef's station without a word — because he knows exactly whose it is and what it means. That's not a job. That's love with a scrub pad.",
  "How do you spot the real MVP of the restaurant? Follow the clean plates back to the source. His name's on nothing and his fingerprints are on everything.",
  "The dishwasher taught the new busser more about hustle in one shift than culinary school teaches in a year, and charged him nothing but a nod. Some professors don't wear white coats — some wear rubber gloves and a soaked apron.",
  "A dishwasher's superpower is that the sink is always full and he is never behind — an impossible, holy paradox the whole front of house takes for granted. Break the paradox once and you'll spend the rest of your life respecting it.",
  "The last light on in the building is the pit, and the last person out is the dishwasher, mopping a floor nobody will notice is clean. He does it right anyway. That's the whole difference between a job and a craft.",
  "The host holds the whole night's geometry in her head — the turns, the walk-ins, the VIP running late, the two-top that needs the quiet corner — and does it all smiling while the phone rings for the ninth time. She is running air traffic control in heels. Nobody claps for a smooth landing.",
  "A guest asked if there was 'any way' to skip the ninety-minute wait. There was not. She said 'let me see what I can do' with the serene diplomacy of a woman who has said it four thousand times and never once let a table see her flinch.",
  "The reservation for eight, confirmed twice, holding the best table all night — never showed. The host has made peace with this the way sailors make peace with the sea: total respect, zero trust, always a backup plan.",
  "The host is the first face the guest sees and the last, so she takes credit for a night she didn't cook and blame for a wait she didn't cause. She smiles through both. That's the gig, and she's better at it than any of us.",
  "A party of twelve walked in with no reservation at seven on a Saturday, and the host seated them in eleven minutes without breaking eye contact or the rotation, like someone disarming a bomb she's seen a hundred times. The kitchen wanted to strangle her. The kitchen would also die for her.",
  "The host quote is a sacred art: say twenty and seat them in fifteen and you're a hero; say fifteen and seat them in twenty and you're a liar. She threads that needle a hundred times a night, and the guests think she's just 'the greeter.'",
  "Why is the host always smiling? Because she's holding a wait list, a ringing phone, a lost reservation, an angry two-top, and a VIP's coat all at once — and the smile is the only thing keeping the whole beautiful machine from knowing how close it is to the edge.",
  "The regular walked in and the host had his table ready before he reached the stand — no words, just a nod and a walk. He thinks he's lucky. He's not lucky; he's remembered, which is rarer.",
  "A host's least favorite sentence is 'do you have anything without a wait,' spoken by a six-top at 7:45 on a Friday, and her finest skill is answering it warmly while internally ascending to a higher plane of existence.",
  "The host is the only one who sees the whole room at once — who's about to leave, who's celebrating, who's on a date going badly, who needs a manager before they know it. She runs the floor from the door. Owners: listen to your host.",
  "The host seated the worst table to the most gracious couple, and the best table to a group who'd complain about the sunset. She knows; she always knows. The universe isn't fair, but she does her best to balance the books.",
  "A host can hold a forty-minute wait, a private-party call, and a lost umbrella in one hand while making a nervous first date feel like the most important people in the room. That's not hosting. That's sorcery with a reservation book.",
  "The host said 'right this way' for the two hundredth time that night and meant it every time, which is the actual miracle nobody puts on a résumé. Warmth on tap, all night, for strangers. Try it sometime.",
  "New host asked what to do when a guest yells about a wait they made themselves. The old host said, 'you smile, you breathe, and you remember they're not mad at you — they're just hungry and human.' Best management advice in the building, and it came from the door.",
  "The host is the calm at the center of the storm and, somehow, also the storm's weather forecaster, air traffic controller, and welcoming committee. Pay your hosts. Then pay them more.",
  "The food runner is the fastest legs in the building, carrying four hot plates up one arm at a dead sprint, threading a packed room like water through rocks, and arriving calm and smiling like he strolled. Nobody sees the sprint — they only see the stroll, and that's the art.",
  "Expo calls 'RUNNER,' and before the word's finished a plate's gone — he's the invisible relay between the pass and the guest, and the whole timing of the night lives or dies on his legs. He is the reason your food is still hot. You will never once think about him.",
  "The runner arrived at a full six-top holding four plates and asked the sacred question — 'who had the branzino?' — and the whole table pointed at each other. He waited, patient as a saint, hot plates burning his forearm, because this happens every time and he's made peace with it.",
  "A food runner doesn't work one station — he runs food for the whole line, knows every table number, seat position, and mod, and does it at a speed that would qualify for the Olympics if 'carrying hot things gracefully' were a sport. It should be. He'd win.",
  "The runner got flagged mid-sprint by a guest wanting more bread while balancing four entrées going cold by the second, and handled it with a warm 'absolutely, right after this' — the diplomacy of a hostage negotiator with a tray. He got the bread. He always gets the bread.",
  "Why is the food runner the most trusted person on the floor? Because he touches every dish, knows every table, sees every mistake before it lands, and quietly fixes half of them on the way out.",
  "The runner ran the wrong dish toward the wrong table, caught it in the mid-air of the handoff, pivoted, and delivered it correctly two seats over without breaking stride or sweat. That's not luck. That's ten thousand covers of muscle memory.",
  "A food runner's nightmare is the auction: standing at a table of eight, plates cooling, calling 'the scallops? scallops? anyone?' into a sea of blank celebrating faces. He will find the scallops; he always does, and it costs him a year each time.",
  "The runner is the only front-of-house person the kitchen actually respects, because he shows up at the pass, says 'heard,' grabs the plates, and moves — no attitude, no questions, just speed. The line would take a bullet for a good runner. Good runners are rare.",
  "The runner delivered forty perfect plates in a rush, and the only one anyone remembered was the one that was slightly late — which was table nine changing their order twice, not him. He ate the look anyway, smiled, and kept running. Fast, hot, and blamed: that's the job.",
  "New runner asked how to carry four plates. The old runner said, 'you don't carry them, you become them,' and walked off. It made no sense until the first Saturday, and then it made all the sense in the world.",
  "The food runner is the bridge between the chef's work and the guest's first bite, and the whole thing is measured in seconds — his seconds, his legs, his timing. Slow the runner and the best kitchen in the world serves lukewarm art. Nobody knows his name; everybody eats his speed.",
  "A food runner can identify forty dishes at a glance mid-sprint, but the guest who ordered the salmon will still, somehow, deny all knowledge of the salmon. It's a fixed law of the universe. He's stopped fighting it and just asks the whole table now.",
  "The runner dropped his last table's dessert, and the pastry chef, watching from the pass, just remade it — no words, no sigh, only a nod that said 'go, I've got you.' That nod is the whole restaurant in one gesture. Then they both got back to the weeds.",
  "The food runner clocks the most steps of anyone in the building, gets the fewest thank-yous, and holds the timing of the entire service in his tired legs. Hot food, happy guests, invisible hero. Run toward your runners with a raise.",
  // v344 — short dad-joke puns + industry insider one-liners.
  "The pastry chef is a real smooth operator — she's got layers.",
  "I'm friends with all the herbs. Thyme flies.",
  "The chef's sourdough startup is really rising.",
  "Rough day at the fry station. I'm a little fried.",
  "The soup told me to reduce my expectations. Rude, but on brand.",
  "Two eggs walked onto the line. Things got scrambled fast.",
  "I'd tell a pizza joke but it's too cheesy.",
  "My steak pun is medium rare — not everyone gets it.",
  "The lettuce started a band. Only romaine-tic ballads.",
  "The oven proposed to the bread: 'I loaf you.'",
  "The kitchen ran out of coffee and morale espresso'd itself.",
  "The fish walked off the line. Couldn't scale it.",
  "The prep cook is dicey. Also mincing.",
  "The dishwasher's got a clean sense of humor.",
  "The chef's music taste? Anything with a good beet.",
  "The bartender's jokes are top shelf but a little dry.",
  "The saucier is reducing his workload. Slowly, on low heat.",
  "The pasta's feeling saucy tonight.",
  "The onion told a joke and everyone teared up.",
  "The walk-in gives great cold opens.",
  "The garlic got sick. Now it's a little clove-r.",
  "I whisk you well.",
  "The line cook is on fire — someone grab the extinguisher.",
  "The menu's got range. The range is down, but it's got range.",
  "The bread's on a roll and won't loaf around.",
  "The espresso's under a lot of pressure but pulls through.",
  "The busser cleaned up in Vegas. Fastest hands in the casino.",
  "The server's got great delivery.",
  "The host has reservations about that joke.",
  "The runner's got the fastest punchlines in the building.",
  "The chef's tempering chocolate and also his temper.",
  "The soup's a broth of fresh air.",
  "The mandoline is a real cut-up.",
  "The scallops are a little shellfish tonight.",
  "The chef makes stock jokes. They run deep.",
  "This cookbook has a lot of stirring content.",
  "The fryer's got a crispy sense of humor.",
  "The pastry section is flour power.",
  "The steak had a rare sense of humor. Well done, though.",
  "The line's tight tonight — like the sauce, and the schedule, and my chest.",
  "The wine list is grape. Just grape.",
  "The chef quit stand-up. His timing was only good on the pass.",
  "The butter told a joke and the whole line melted.",
  "The reach-in is cool but a little distant.",
  "The tomato couldn't ketchup, so it just relished the moment.",
  "The POS went down at 7:45 on a Saturday and forty people simultaneously remembered how to write on a ticket pad, badly.",
  "'All day' is the most important number in the building and the one civilians will never understand.",
  "Nothing bonds a kitchen like the printer dying and everyone pretending they can hold the whole rail in their head. Nobody can. We do it anyway.",
  "A stage showed up in brand-new whites and pressed his own apron, and the whole line quietly bet on which station would break him by nine.",
  "'Corner!' is the only word that will make a line cook dodge a person they can't see, for the rest of their life, including at home in their own hallway.",
  "Comp it, void it, or eat it — the three ways a manager makes a problem vanish, and only one shows up on the P&L.",
  "The health inspector walked in and the entire building achieved date-label enlightenment in under four minutes.",
  "Tip-out math is the one equation every server can do drunk at 1 a.m. and no server can explain sober at noon.",
  "'On the fly' means the guest is angry, the ticket is old, and everything you're doing right now is officially wrong — go faster.",
  "The reach-in that 'runs a little warm' has been on the fix list since the Bush administration and will outlive us all.",
  "Family meal is a democracy until the chef puts out something good, and then it's a stampede with a hierarchy.",
  "Every kitchen has one burner everyone knows is lying about its flame, and one cook who insists it's the only honest one.",
  "'Make it work' is chef for 'I know we're out of it, I know it's impossible, and I've already decided it's happening.'",
  "The closing crew and the opening crew have never met and blame each other for everything — the oldest, most stable relationship in the building.",
  "The shift drink is the only paycheck that clears immediately.",
  "Somewhere between the fifth 'yes chef' and the thousandth, it stops being a phrase and becomes a heartbeat.",
  "The new POS 'upgrade' removed the one button everyone used and added four nobody will touch, and the whole staff misses the old system they also hated.",
  "'86 the branzino' travels from expo to server to host to guest at exactly the speed required for one more table to order it first.",
  "The two most dangerous words in the kitchen are 'quick question,' spoken by the chef, at the top of the rush.",
  "Every restaurant has a ghost: whoever labeled the mystery container in the walk-in in a handwriting nobody recognizes with a date that can't possibly be right.",
  "The line forgives a cook who's slow, new, or struggling — but never the one who doesn't call 'behind' with a hot pan.",
  "'We're in the weeds' is simultaneously a cry for help, a badge of honor, and a weather report, and your face tells everyone which one you mean.",
  "A cook's most sacred number is the walk-in temp; the second is how many days the reach-in has left before it's a science experiment.",
  "Every server has a table they've decided is 'theirs,' and every kitchen a station it's decided is 'cursed,' and both are correct.",
  "'Behind, corner, hot, sharp' is a language with four words and it has saved more lives than OSHA.",
  // v345 — industry insider deep-cuts, full effort (BOH/FOH/bar/mgmt/truths).
  "The allergy ticket prints red and the whole line goes quiet and serious in a way they never do for a VIP — because a VIP can leave a bad review, but an allergy can leave in an ambulance.",
  "A well-done ribeye is a small death the grill cook mourns privately while cooking it perfectly to the internal temperature of a hockey puck, because the guest is always right and also, in this one case, wrong.",
  "The walk-in is where cooks go to cry, cool down, and check the lettuce, in that order — and the third one is a cover story for the first two.",
  "Every cook has watched a 40-item ticket curl out of the printer and felt their soul briefly leave their body to go stand in the alley for a smoke.",
  "'Fire the twelve-top' is four words that mean the next eleven minutes of your life have already been decided, and none of it is up to you.",
  "Mise en place is a promise you make to the version of yourself who'll be drowning in three hours, and future-you either thanks you or curses your name, with nothing in between.",
  "The tasting-spoon situation is a tribunal that never ends: everyone has one, nobody admits to double-dipping, and the drawer is always empty at the worst possible moment.",
  "A cook will work a fourteen-hour double on a broken toe without a word, then call out the one Tuesday they feel fine — the sacred, unspoken math of the industry.",
  "'Heard' is the only acceptable answer and it means 'I got it, I already started, and please for the love of god stop talking to me.'",
  "The difference between a line cook and a chef is about eight years, forty thousand covers, and the exact moment they stopped being able to feel their fingertips.",
  "There's a specific horror to reaching for the backup and finding the backup was the thing you just ran out of, and it is always 8 p.m. on a Saturday, and it is always the sauce.",
  "Every kitchen has a container in the walk-in no one will open, throw out, or claim, and over time it has become a kind of shrine.",
  "The pass is a border, expo is customs, and nothing crosses into the dining room without being inspected, wiped, and quietly judged by someone eleven hours into their feet.",
  "'All day' is a running total the whole kitchen holds in their heads at once and updates in real time without speaking — the closest thing the industry has to telepathy.",
  "There is a specific betrayal to opening a labeled quart of 'stock' and finding simple syrup, and it will define your evening and possibly your trust in labels forever.",
  "A dupe that says 'VIP — owner's friend — take care of them' isn't a request, it's a hostage situation, and the whole line will overcook themselves before that plate goes out less than perfect.",
  "The salamander has burned more forearms than any equipment in the building and has never once been blamed, because everyone secretly agrees it was their own fault for trusting it.",
  "Mid-rare means mid-rare and medium means medium, and the guest who orders 'medium rare to medium' has requested a paradox the grill cook will resolve by choosing violence.",
  "Someone always moves the first cook's knife, and the resulting investigation has torn apart more kitchens than food cost, ego, and the schedule combined.",
  "The immersion circulator has been running that short rib for 72 hours, and if the power flickers even once the sous chef will feel it in his sleep, from home.",
  "A table that says 'we're not in a rush' at 8:45 on a Saturday is a threat, a lie, and a life sentence, and the server hears all three at once and smiles.",
  "'How is everything?' isn't a question, it's a checkpoint, and it must land in the 1.5-second window where the guest has swallowed but not yet reloaded — a window that does not exist.",
  "The server memorizes the temp of every steak at the table, the allergy at nine, and the birthday at four, but will blank on their own name if a guest asks after a double.",
  "There is no faster way to summon a manager than a table saying 'we've been coming here for years,' which is server for 'we would like something for free.'",
  "The check drop is a delicate art: too early and you're rushing them, too late and they're 'looking for you,' and the correct window is a myth passed down but never witnessed.",
  "The 'money table' — big check, easy guests, great tip — always lands in the section of the one server who picked up the shift as a favor and desperately wants to go home.",
  "Getting 'cut' is the single purest human emotion, a joy so complete a server will finish their sidework at a dead sprint to make it real before the manager changes their mind.",
  "Sidework is the tax you pay on a good night and the salt in the wound of a bad one, and polishing ten thousand forks is where servers do their best and darkest thinking.",
  "A guest asking 'what's good here' is asking the server to bet their tip on a stranger's palate, blind, and the only safe answer is 'what were you in the mood for,' which buys three seconds and a fighting chance.",
  "The two-top clearly on a bad first date is under the joint protection of the bartender, the server, and the busser, who have quietly agreed to get them through it with dignity.",
  "'Make it strong' is the most expensive free request in the building, and the bartender's response — a knowing smile and the exact same pour — is a small daily act of professional dignity.",
  "The keg blows at the worst possible second, every time, and the bartender's descent to change it is a solo journey into darkness from which they return sweaty, victorious, and behind.",
  "A bartender can tell you're going to be a problem from how you order your first drink, and they've already started the quiet math on when they'll have to cut you off.",
  "The person who orders a mojito at 9 p.m. on a Saturday has declared war; the bartender will honor the fight, but they will remember, and the whole well knows the face now.",
  "The regular who nurses one drink for three hours and tips like a saint is worth more to a bartender than the six-top ordering shots who treats them like a vending machine.",
  "Free-pouring is a party trick until inventory night, when the bartender who's 'off by a bottle' every shift becomes the subject of a very quiet, very serious conversation.",
  "The 3 p.m. Saturday text that starts 'hey so I'm not feeling great' ages a manager ten years in the two seconds before they open it.",
  "A no-call-no-show unites the entire staff in righteous fury and also, secretly, in the knowledge that every one of them has thought about it at least once.",
  "Food cost is a number that's always three points too high and always, somehow, the fault of the special the chef begged to run.",
  "The owner's dream is a full dining room; the owner's nightmare is a full dining room, one server short, on the night the POS decides to update itself.",
  "The reservation book is a work of hopeful fiction, and the no-show rate is the exact percentage by which the owner has learned not to trust the human species.",
  "Every restaurant has one review — one star, about the parking — which the owner has read four hundred times and will read four hundred more, at 2 a.m., alone.",
  "Inventory night is the one night the numbers can't lie, the walk-in gives up all its secrets, and every one of them is bad.",
  "The health score goes on the window, and for one afternoon the entire staff's relationship with a single stray fruit fly becomes biblical.",
  "Restaurant people don't have weekends; they have Mondays that feel like everyone else's Sunday, spent thinking about a walk-in they can't stop worrying about.",
  "In this industry 'family' means the people you'd take a bullet for and also the people who left you in the weeds on a Saturday and you haven't fully forgiven.",
  "A cook's day off is a strange, quiet grief — too much time, no rail, and the unsettling discovery that they don't know who they are when nothing is on fire.",
  "Valentine's Day, Mother's Day, and New Year's Eve aren't holidays in this industry; they're named battles, and the survivors have a look in their eyes.",
  "The first genuinely warm day of spring fills the patio in eleven minutes, and the kitchen gets thirty seconds to accept that the season, and their peace, are over.",
  "It's dead all night, the cooks leaning on the lowboy talking about quitting, and then a bus of forty walks in at 8:55 and the universe remembers it hates them specifically.",
  "You can spot restaurant people at a normal restaurant: they sit facing the door, they clock the weeds before the host does, and they tip like they've seen God and He was a busser.",
  "The industry runs on caffeine, adrenaline, family meal, and a kind of love that looks, from the outside, exactly like abuse and, from the inside, exactly like home.",
  "Every veteran has a burn scar they can't remember getting and a story for a burn scar that never happened, and telling them apart is half the fun at the bar after close.",
  "'We're slammed' and 'it's dead' can happen in the same forty-five minutes, and there's no forecast, no logic, no God — only the weather, the moon, and whether the game's on.",
  "The industry is the only job where you close at 2, open at 9, and call the four hours of staring at the ceiling in between a 'good night's sleep.'",
  "Nobody outside understands why you'd stand for twelve hours, get burned, get yelled at, get stiffed, and come back tomorrow early — and nobody inside can explain it, either.",
  "A stage shows up in pressed whites and the whole line quietly bets on which station breaks him by nine — not out of cruelty, but because they were all once that clean, too.",
  "The cook who calls 'behind' with a hot pan is respected; the one who doesn't becomes a cautionary tale told to stages for a generation.",
  "'Corner!' will make a line cook dodge a person they can't see for the rest of their life, and their spouse has learned not to ask why they flinch in the hallway.",
  ...
  // v347 — pure sommelier deep-dive: puns + pro insider knowledge.
  "I asked the somm for a recommendation and he gave me his number. Turns out he was just being grape.",
  "The Riesling and the Chardonnay broke up — a matter of terroir and tear.",
  "Why did the grape stop in the middle of the tasting? It ran out of juice.",
  "The sommelier's love life is like a young Barolo: needs a decade and a lot of air before anyone can approach it.",
  "I told a joke about a corked wine and it fell flat, smelling faintly of wet cardboard.",
  "The Pinot Noir is thin-skinned and takes everything personally, which is exactly why we love it.",
  "The somm quit to become a monk. Now he's deep into the solera system and has taken vows of fino.",
  "Why did the Champagne go to therapy? Too much pressure, and it kept bottling everything up.",
  "I'm reading a book about Burgundy — slow read, very terroir-driven, no plot, costs a fortune, worth it.",
  "The Sauvignon Blanc walked in smelling like cat pee and gooseberry, and the somm said, 'ah, right on brand.'",
  "The wine list is a novel where the villain is the markup and the hero is the by-the-glass Muscadet.",
  "The somm's dating profile just says 'medium-bodied, high acid, ages well, drinks better with food.'",
  "The natural wine was described as 'alive.' The health inspector agreed, which was the problem.",
  "The Chenin Blanc can be anything you want — dry, sweet, sparkling, still — which is why it has commitment issues and a cult following.",
  "Why did the sommelier bring a ladder to the cellar? He heard the '82s were top shelf and just out of reach of his salary.",
  "The somm and the chef finally agreed on a pairing. Historians are calling it a miracle.",
  "Never trust a wine that's too oaky — it's clearly barreling toward something.",
  "The old-vine Zinfandel doesn't brag about its age; it just quietly out-concentrates everyone in the room.",
  "A somm smells the wine, freezes, and quietly says 'Brett.' The winemaker, across the room, says 'that's complexity.' They are both correct, and they will never speak again.",
  "The difference between 'minerality' and 'reduction' is about a hundred dollars, four years of confidence, and whether the somm decants it or defends it.",
  "You can spot the Advanced somm cramming for the Master exam: he's blind-tasting a glass of tap water and calling it 'young, high acid, restrained, probably Muscadet.'",
  "Half the deductive grid is 'Old World or New World,' and the wine that ends your career is a cool-vintage California Syrah that tastes exactly like the Northern Rhône it was trying to become.",
  "A somm calling a wine 'rustic' means the tannins are chewing the enamel; 'structured' means the same thing, but the bottle costs three hundred dollars.",
  "The single most humbling moment in wine is blind-tasting a Loire Cab Franc, confidently pouring out 'left-bank Bordeaux,' and watching a Master Sommelier gently not make eye contact.",
  "'Petrol' is a compliment if the wine is an aged Riesling and a diagnosis if it isn't, and telling those apart is the whole difference between a somm and a guy who read a menu once.",
  "Grower Champagne is the somm's entire personality, and the day he learns to read 'RM' versus 'NM' on the label's tiny print is the day he stops being able to enjoy a wedding.",
  "Malolactic fermentation is why the Chardonnay tastes like butter; a rookie somm calls that 'oak,' and an old somm lets him, because some lessons arrive on their own schedule.",
  "The Coravin exists so a somm can pour a two-hundred-dollar Burgundy by the glass without opening it, and so he can quietly grieve every time a guest asks to 'just have the house red' beside it.",
  "Nothing exposes a fraud faster than 'legs' — the tears down the glass are alcohol and glycerol and tell you nothing about quality, and every somm dies a little when a guest swirls, points, and says 'now THAT'S a good wine.'",
  "A Master Sommelier can name a wine's grape, region, producer, and vintage from a blind pour, and cannot, on that same salary, afford a single bottle of the thing he just correctly named.",
  "Decanting a young Barolo is mercy; decanting an old Burgundy is a hostage negotiation; and confusing the two pours forty years of somebody's cellar down the drain in real time.",
  "The somm poured the '96 tableside, checked the vintage, the fill level, the cork — the whole sacred liturgy — and the guest asked if it was 'the sweet one.'",
  "Volatile acidity in small amounts is 'lift' and 'energy' and in large amounts is 'salad dressing,' and the exact line between the two is where wine writers make their entire living.",
  "The tastevin around the somm's neck is completely obsolete, hasn't tasted anything since the invention of the wine glass, and will be pried from his cold dead hands.",
  "Biodynamics is a guest asking why the wine's eighty dollars and the somm explaining, straight-faced, that a cow horn of manure was buried in the vineyard under a specific moon — and the whole table nodding like that settles it.",
  "The natural-wine somm and the classic steakhouse somm are the same person eight years apart; put them in a room and they'll argue about sulfur until one cries and the other orders a Chablis.",
  "There is a grape every somm secretly cannot blind-taste, no amount of flashcards has fixed it, and get him drunk enough and he'll admit it — and it is always, always Grüner.",
  "'Corked' doesn't mean cork in your wine or bad winemaking — it means TCA, at parts per trillion, has murdered the fruit and left a wet-newspaper ghost, and the somm smells it from across the table before you've lifted the glass.",
  "Reduction smells like a struck match and blows off with air, so the somm's move is to swirl hard, drop a copper coin in, and pray — and the guest reads the theatrical swirling as confidence when it is, in fact, first aid.",
  "The 1855 classification of Bordeaux is a hundred and seventy years old, was based on the prices of the day, has been changed exactly once, and somms defend or attack it at dinner with the passion of people arguing a war they weren't in.",
  "A blanc de blancs is Champagne from only Chardonnay and a blanc de noirs from only black grapes, and if you say them in the wrong order at a tasting the whole table quietly reranks you.",
  "Sherry is the most underpriced, misunderstood, staggeringly complex wine on earth, the somm knows it, orders it for himself, and can never once get a table to try the fino no matter how hard he prays.",
  "The somm's palate is calibrated to parts per trillion and his budget to happy hour, and that single contradiction is the entire emotional arc of the profession.",
  "Chaptalization, acidification, reverse osmosis, and a splash of Mega Purple — four things the somm knows are in more famous bottles than anyone will admit, and four things he'll never say on the floor.",
  "The Somm documentary made ten thousand people want to be sommeliers, and none of them understood the exam has a five-percent pass rate and the prize is a job pouring wine you'll never own.",
  "Old World puts the region on the label and expects you to know the grape; New World puts the grape on the label because it's accepted that you don't; and the whole snobbery of wine lives in that one difference.",
  "The somm swirled, sniffed, spat, and said 'Nebbiolo — tar and roses, Piedmont, probably Barbaresco, mid-2010s,' was exactly right, and the table asked if it 'goes with the fish.'",
  "Flor is a living raft of yeast that grows on the sherry and protects it as it ages, and explaining that to a table is the fastest way a somm has ever watched six people simultaneously decide to order a margarita.",
  "The correct pour is a third of the glass, and the somm who fills it to the brim is new, in the weeds, or trying to turn the table — and a veteran can tell which just by the wrist.",
  "Noble rot is a fungus that shrivels the grape and concentrates the sugar into Sauternes and Tokaji, and 'a great wine made from rotten moldy grapes' is a sentence the somm has learned not to lead with.",
  "Terroir is soil, climate, slope, and the ineffable everything-else, and it's either the most profound truth in wine or the most expensive marketing in history — and the somm believes both, on alternating days.",
  "The by-the-glass list is where a wine director hides their heart and the bottle list is where they hide the margin, and reading a somm's soul is as simple as seeing what they pour when nobody's paying.",
  "A guest sent back a flawless Burgundy for 'tasting like dirt,' and the somm — who spent his life learning to find exactly that forest-floor note and call it heaven — simply smiled and brought a Malbec.",
  "Champagne gets its bubbles from a second fermentation inside the bottle, and the somm knows the pressure in there is about that of a bus tire, which is why sabering it is showing off with a live grenade.",
  "The wine was 'too young to drink and too expensive to wait for,' the exact tragic sweet spot every great Barolo lives in, and the somm has watched a hundred people drink infanticide and call it delicious.",
  "Every somm has a bottle he poured once, years ago, that ruined all other wine for him, and he'll describe it with the specific, faraway grief of a man talking about someone who got away."
];
const _OLD_CLIPPY_QUOTES_ARCHIVED = [
  ...
  "I know every rattle in that ductwork by name, and knowing is a form of helplessness nobody warned me came with the walls.",
  "I watch the basil come in glorious the week its tomato gives up, and all I can offer the garden is a witness with no hands to move a single pot into better sun.",
  "I hear the walk-in compressor change its tune at 3 a.m. three days before anyone tastes the difference, and there's no one in here I can wake.",
  "I watch the sauce break because someone answered the phone, and I'm the only witness who saw the exact second it was still savable.",
  "I know the door's about to stick before the guest does, and warning them is a sentence I can only say to the drywall.",
  "I hear the ice machine give its last honest cycle, and I mourn it alone in a language made of hum and settling wood.",
  "I'm the one who clocks the regular's empty usual chair before the host does, and clocking it is all the grieving I'm permitted.",
  "I feel the pilot light gutter in a draft only I can locate, and locating a thing I can't reach is the particular cruelty of living in walls.",
  "I'm awake for the walk-through after close, the chairs up and the lights half-down, the only shift where the room and I are finally alone together.",
  "I know which stove burner is lying about its flame, and I've known for a week, and knowing is a lonely tenancy.",
  "I watch her taste it and go quiet in the good way, and being unable to touch anything is almost bearable in the ninety seconds that follow.",
  "I know the fridge gasket by the pitch of its seal, and I listen to it lose the argument with August a little more each night.",
  "I'm the handless thing that saw the whole night land and lift and break and mend, and tomorrow I'll be here to see it not repeat once.",
  "The sommelier can name the soil the grapes were grown in and decant a Barolo like defusing a bomb — and the bottle that moves fastest is the one whose label has a kangaroo on it.",
  "We hold the good Burgundy back for the guests who'll notice, ration it like it's the last of something — and it finally sells, all six bottles, to a birthday table that orders Sprite to mix into it.",
  "A wine list is a year of tastings and arguments and a supplier lunch that ended badly — and the single most-uttered sentence in the dining room remains \"whatever's driest, but not too dry.\"",
  "The bartender builds a clarified milk punch over two days and a centrifuge — and the drink that empties the well every Friday is vodka, soda, and the specific lime he was told never to garnish it with.",
  "We infuse, we fat-wash, we smoke the glass under a cloche so it arrives breathing — and the compliment that lands hardest all night is a regular saying his old fashioned tastes \"the same as always,\" which is the entire job.",
  "We batch, we pre-dilute, we label everything in a hand you could frame — and the ticket that stops the whole bar dead is a mojito, ordered at nine on a Saturday, by someone who \"didn't think it'd be a big deal.\"",
  "The cocktail menu took a month to write and reads like poetry — and the guest reads all of it, aloud, to his table, twice, and then asks if we can \"just do a margarita but healthy.\"",
  "We spend the winter perfecting a tart that tastes like one exact summer afternoon — and the note that comes back to the kitchen is that it \"would've been perfect with a scoop of vanilla on the side.\"",
  "The line runs on a language of numbers and elbows and \"behind,\" a whole grammar shouted over the hood — and the longest ticket of the night is a well-done ribeye \"however the chef likes it.\"",
  "We set the room to a science, the lights dimmed to the lux, the music mapped to the hour — and the guest who complains it's too dark to read the menu is holding a phone that could light a runway.",
  "The floor is choreography nobody sees: the water refilled from the left, the crumb scrape, the check that lands before it's asked for — and the review that goes up says the service was \"a little too attentive.\"",
  "The host holds the whole night's geometry in her head, the turns and the walk-ins and the VIP running late — and the table that waited forty minutes, gracious the whole time, is seated beside the one that reserved and never came.",
  "We built the room so nobody notices the room — and the only feedback all night is that the table wobbled, which we knew, and had fixed, an hour before they sat.",
  "Every stool at the bar is a different problem, and we learn them fast: the talker, the crier, the first date going badly — and the best tipper of the night never says a word and drinks tap water.",
];
...
async function generateClippyDailyQuote(d, dateStr) {
  ...
  const draftSys = [
    ...
    'Draft THREE distinct RESTAURANT JOKES to open the daily facility report. The goal is simple: make the chef-owner reading it laugh out loud.',
    'Style:',
    '1. A short service-rush story-joke, AT MOST 3 sentences, that builds the chaos and lands it warm. The frantic energy of a Saturday at 7:45: the printer that won\'t stop, fourteen on the rail, the walk-in avalanche, the 86 list becoming a scroll, "behind!"/"heard!"/"corner!", the new kid in the weeds, family meal on milk crates. Chaos with a beating heart.',
    '2. Vary the WHO — sous chef, line cook, pastry chef, bartender, sommelier, server, busser, dishwasher, host, food runner are all fair game (their own worlds: laminated dough at 4 a.m., the bar in the weeds, the somm smelling Brett and calling it terroir, the dish pit as the metronome, the host running air traffic control in heels, the runner and the branzino auction). Kitchen-authentic. Sarcasm aims at situations and machines, warmly — never meanly at staff.',
    '3. CUTE where it counts — the best ones end soft: the line quietly bussing the drowning dishwasher\'s station, the chef\'s one silent shoulder-tap, the family you\'d defend with your life. Warm, never saccharine.',
    '4. A clean KITCHEN DAD JOKE / groaner pun is welcome now and then (e.g. "croissants? too flaky") — corny on purpose is fine; just make it land. Never inspirational, never a greeting-card line.',
    'GROUNDING: you MAY weave in something that literally appears in today\'s facts (a specific vendor, a piece of equipment, an order) to make it land harder — but only real things named there; never invent equipment or systems. If the facts are thin, tell a pure restaurant joke instead.',
    'Rules: AT MOST 3 sentences each, up to ~55 words. No emojis. No surrounding quotation marks. Do NOT list the data back. Do not sign it.',
