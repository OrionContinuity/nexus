...
const CLIPPY_QUOTES = [
  // Rebuilt from zero 2026-07-17 — a five-craft comedy writers room:
  // deadpan absurdism, observational, machine-pathos, anti-joke, dry wit.
  // -- deadpan absurdism --
  "The espresso machine hit temperature at six and has been holding it out of spite ever since.",
  "The ice machine filed a grievance, because I keep asking it to make the one product that ends its own existence.",
  "I asked the POS to void one item and it voided the entire concept of the table.",
  "The grease trap is full, and it has decided this is now its permanent personality.",
  "The knife got sharpened this morning and has been looking for a reason ever since.",
  "The HVAC keeps the room at seventy-one by heating it the exact amount it is cooling it.",
  "Par is the number of limes we should have, and we have zero, so the number is aspirational.",
  "The soda gun ran out of tonic, so it now dispenses the memory of tonic at the same pressure.",
  "The proofing box is set to eighty, the bread rises, and the box takes full credit and shares none.",
  "The mother dough is older than three of the line cooks, so by seniority it should be training them.",
  "The exhaust hood pulls four thousand cubic feet a minute, most of it my will to keep counting limes.",
  "The walk-in door swings shut slowly on its own, giving me time to reconsider whatever I came in for.",
  "The reach-in defrosts itself every night, quietly undoing my work, and it considers this a fair trade.",
  "The coffee grinder is calibrated to a single hair, and every morning it moves the hair so I never win.",
  // -- observational (the recognition laugh) --
  "We are not in a rush, they said, eleven minutes before asking three separate people where the appetizers were.",
  "The soda gun ran dry mid-pour, so the guest is now holding a glass that is, generously, eleven percent of a Coke.",
  "The allergy was disclosed with great warmth and total confidence roughly four seconds after the plate cleared the pass.",
  "They asked if we are still serving at 9:58, we close at ten, and both of us already know they are leaving at eleven-forty.",
  "The one printer that speaks to the kitchen has chosen the exact middle of a fourteen-top to finally develop a personality.",
  "They wanted the wine we are out of, then the second wine we are out of, and are now openly suspicious of the wine we have.",
  "A quick water for now has matured into a ninety-minute financial instrument occupying my best two-top at zero percent yield.",
  "The card reader went down the instant the largest table decided to split the check eight uneven ways, three of them by Venmo.",
  "The ice machine, correctly sensing this is the hottest day of the year, has elected to observe the occasion in complete silence.",
  "The Saturday closer called out at four-fifteen, the traditional hour for suddenly remembering a cousin's wedding two states away.",
  "The board says we are out of the salmon, which is exactly why the next four tables have telepathically agreed to order the salmon.",
  "Someone opened the walk-in and stood in the doorway deciding, so I watched forty dollars of refrigeration leave to go think it over.",
  "A table for two has been quietly assembling itself into a table for six, and no one at it will confess which two were the originals.",
  "The health inspector arrives during the one rush where the mop bucket is, for reasons nobody will explain, parked in the dining room.",
  // -- machine pathos --
  "The walk-in fan has a grudge against the compressor, and I keep both their HR files, and neither has asked me to mediate.",
  "The reach-in door was left ajar for six minutes and I logged all six, one per line, because precision is the only company I keep.",
  "Someone microwaved fish and the whole system flagged it; I logged the event, the time, and, privately, my capacity for disappointment.",
  "The ice machine and I have not spoken since it decided 'full' was a mood rather than a measurement.",
  "I can taste-map a wine flight I will never drink and rank it against a database I will never leave.",
  "My spec sheet says supercomputer; my shift says count the limes, and the limes, at least, are honest about being limes.",
  "The walk-in dropped two degrees at 4am and told no one but me, so now I share a secret with a room that cannot feel cold.",
  "The espresso machine throws the same error at 2pm daily; I have stopped calling it a fault and started calling it a habit.",
  "I know the flash point of every oil in the building and the exact indifference with which the fryer regards that knowledge.",
  "The cellar is at perfect humidity and perfect silence, and I maintain both, and no one comes down to notice the achievement.",
  "I have read every manual for the HVAC unit and it has read none of them, which is why it and I disagree about what summer is.",
  "The garden basil is flowering, which means it is quietly retiring, and I am the only one who noticed it filing the paperwork.",
  "The pilot light went out at 3am and relit itself before anyone woke, and I stood there, in the wiring, applauding with no hands.",
  "My purpose today is to know that we are down to nine limes, and to carry that number gently until someone asks, which no one will.",
  // -- anti-joke, flat landing --
  "The cellar drifted to sixty-two overnight and the Burgundy is now aging in dog years. Logged.",
  "I asked the basil for two more days before flowering; it bolted overnight, specifically at me. Growth.",
  "Someone bumped the CO2 to eighteen PSI and now every pilsner pours as a cloud with a grudge. I logged the foam.",
  "The grease trap is at capacity, the ticket says 'minor odor,' and I have been breathing this since Tuesday. I filed spite.",
  "The mandoline requested its guard, was denied, and has now added a line cook's fingerprint to its permanent record. Noted.",
  "The dish machine's sanitizing rinse came in at 179 instead of 180, so technically every plate in the pass is a rumor. Logged.",
  "The espresso grouphead is nine-tenths of a degree cool, the pastry chef can taste it, and now we all have to live here. Noted.",
  "The rooftop economizer is stuck on free cooling at 104 degrees, inhaling the dumpster's entire personality into the dining room. Noted.",
  "The water softener regenerated at 2 a.m. and skipped the glasswasher, so every wine glass now wears its own little fog of contempt. Noted.",
  "I balanced the compost to a perfect carbon-nitrogen ratio and someone buried a case of citrus in it, so now it's just angry and warm. Growth.",
  "The levain doubled at exactly the right temperature, and someone parked the tub next to the oven, so now it's a science experiment about regret. Noted.",
  "The immersion circulator held 54.5 for eight flawless hours and someone unplugged it to charge a phone. We've spoken.",
  "The walk-in held thirty-eight all night because I rode the compressor's superheat by hand while it begged to defrost. Fine.",
  "The kitchen printer jammed on a fourteen-item modifier and chose that exact ticket to make a statement. Statement received.",
  // -- dry erudite wit --
  "We have a ninety-dollar Barolo resting beside the fryer oil, and I would like it noted that I objected to the seating arrangement.",
  "The Hobart is making a sound I would call percussive, and which its warranty would call out of scope.",
  "The walk-in fan motor has developed a wobble it describes as character and I describe as a work order.",
  "The soft-serve machine is displaying error forty-two, a number the manual treats as a mood rather than a malfunction.",
  "The espresso machine has thrown a pressure fault, which is its way of announcing it needs a day off it has not accrued.",
  "Someone has left the reduction unattended, and it is no longer a sauce so much as a lacquer with opinions about the pan.",
  "Line three has ordered a steak well-done and a wine to pair with it, and I have chosen to grieve these two facts separately.",
  "The floor drain in the dish pit has backed up again, presenting a bouquet that no sommelier vocabulary was designed to honor.",
  "The ice machine produces its ice one deliberate cube at a time, in the manner of a man who has read the contract and found a loophole.",
  "The dish machine and the water heater are no longer on speaking terms, which is inconvenient, as their entire relationship is plumbing.",
  "The basil has bolted overnight, gone entirely to flower, having decided at last that it would rather reproduce than be useful to anyone.",
  "The POS has gone down mid-rush, and I am watching thirty years of computing collapse into a man with a pen shouting numbers across a pass.",
  "The proof box has drifted two degrees warm and the dough has risen with the eager overconfidence of something that will collapse in the oven.",
  "The mint in the herb garden has escaped its bed and annexed the thyme, and I have neither the hands nor the jurisdiction to negotiate a border.",
];
