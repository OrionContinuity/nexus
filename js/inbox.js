...
(() => {
  ...
  function renderHomeCard() {
    // Home presence is now owned by home-rm.js (Trajan's read, R&M tiles,
    // Decisions card, Work Orders feed, Wins). This function is kept as a
    // no-op for back-compat with the call sites below.
    return;
  }
