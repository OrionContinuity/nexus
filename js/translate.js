...
(function () {
  ...
  async function text(input, target) {
    ...
    try {
      const { data, error } = await NX.sb.functions.invoke('translate', {
        body: { text: input, target: tgt },
      });
...
(function(){
  ...
  // Batch translate — call edge function with texts:[], parse back.
