...
.eq-actionbar-clean {
  ...
  border-top: 1px solid rgba(200, 164, 78, 0.15) !important;
  align-items: center;
...
.eq-actionbar-btn {
  ...
  color: var(--accent, #c8a44e) !important;
...
.eq-actionbar-primary {
  background: linear-gradient(135deg, var(--accent, #c8a44e), #d4b86a) !important;
  color: #1a1408 !important;
  border-color: var(--accent, #c8a44e) !important;
}
.eq-actionbar-primary .eq-ab-icon,
.eq-actionbar-primary .eq-ab-label { color: #1a1408 !important; }
...
.eq-actionbar-zebra .eq-ab-label { color: var(--accent, #c8a44e) !important; }
.eq-actionbar-zebra:active {
  background: rgba(200, 164, 78, 0.25) !important;
}
...
.eq-actionbar-menu-item.danger { color: #e07070; }
...
@media (min-width: 600px) {
  ...
  .eq-dispatch-card { border-radius: 18px; }
}
.eq-dispatch-header {
  display: flex;
  align-items: center;
...
.eq-dispatch-search:focus {
  border-color: var(--accent, #c8a44e);
}
.eq-dispatch-actions {
  display: flex;
  flex-direction: column;
...
.eq-dispatch-call-btn {
  ...
  justify-content: center;
  padding: 14px 18px;
  background: linear-gradient(135deg, #5cb377, #4ea866);
  color: #ffffff;
  border: none;
  border-radius: 12px;
  font-size: 15px;
...
.eq-manual-card-open-btn {
  ...
  justify-content: center;
  padding: 11px 14px;
  background: linear-gradient(135deg, var(--accent, #c8a44e), #d4b86a);
  color: #1a1408;
  border: none;
  border-radius: 10px;
  font-size: 13px;
...
.eq-part-vendors {
  margin-top: 10px;
  padding-top: 10px;
  border-top: 1px dashed rgba(200, 164, 78, 0.15);
}
...
.eq-part-vendor-btn.remove-btn:active {
...
@media (min-width: 600px) {
  ...
  .eq-vendor-card { border-radius: 18px; }
}
.eq-vendor-header {
  display: flex;
  align-items: center;
...
.eq-extract-spinner {
  ...
  height: 32px;
  margin: 0 auto;
  border: 2.5px solid rgba(200, 164, 78, 0.15);
  border-top-color: var(--accent, #c8a44e);
  border-radius: 50%;
...
.eq-extract-part input[type="checkbox"] {
  margin-top: 3px;
  accent-color: var(--accent, #c8a44e);
  flex-shrink: 0;
}
...
.eq-close {
  ...
  border: 1px solid rgba(200, 164, 78, 0.25) !important;
  color: var(--text, #e6dccc) !important;
...
[data-theme="light"] .eq-close:active {
  background: rgba(200, 164, 78, 0.3) !important;
}
